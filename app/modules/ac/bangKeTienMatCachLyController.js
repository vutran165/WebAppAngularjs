acModule.factory('bangKeTienMatCachLyService', [
...
acModule.controller('bangKeTienMatCachLyController', [
    '$scope', '$rootScope', '$window', '$stateParams', '$timeout', '$sce', '$state', '$uibModal', '$log',
    'mdService', 'bangKeTienMatCachLyService', 'clientService', 'configService', '$filter', 'serviceInventoryAndWareHouse', 'serviceInventoryAndMerchandiseType', 'serviceInventoryAndMerchandise', 'serviceInventoryAndMerchandiseGroup', 'serviceInventoryAndCompany', 'serviceInventoryAndDonViHaiQuan', 'serviceInventoryAndUnitUser',
    function ($scope, $rootScope, $window, $stateParams, $timeout, $sce, $state, $uibModal, $log,
        mdService, bangKeTienMatCachLyService, clientService, configService, $filter, serviceInventoryAndWareHouse, serviceInventoryAndMerchandiseType, serviceInventoryAndMerchandise, serviceInventoryAndMerchandiseGroup, serviceInventoryAndCompany, serviceInventoryAndDonViHaiQuan, serviceInventoryAndUnitUser) {
        $scope.tempData = mdService.tempData;
        $scope.robot = angular.copy(bangKeTienMatCachLyService.robot);
        ...
        function filterData() {
            ...
            bangKeTienMatCachLyService.getNewParameter(function (response) {
        ...
        $scope.report = function () {
            ...
            //bangKeTienMatCachLyService.getReport($scope.target);
            $state.go('bangKeTienMatCachLyReport', { obj: $scope.target });
        }
        $scope.printExcel = function () {
            bangKeTienMatCachLyService.postExportExcel($scope.target, "BaoCaoBangKeTienMatCachLy");
        }
    }
]);
nvModule.controller('reportBangKeTienMatCachLyController', ['$scope', '$window', '$stateParams', '$timeout', '$state', '$filter',
    'nvService', 'bangKeTienMatCachLyService', 'mdService', 'clientService',
...
nvService, bangKeTienMatCachLyService, mdService, clientService) {
    ...
    $scope.goIndex = function () {
        $state.go('bangKeTienMatCachLy');
    }
    function filterData() {
        if (para) {
            bangKeTienMatCachLyService.postReport(para, function (response) {
