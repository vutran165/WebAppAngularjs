acModule.factory('doanhNghiepKeKhaiTemService', [
...
acModule.controller('doanhNghiepKeKhaiTemController', [
    '$scope', '$rootScope', '$window', '$stateParams', '$timeout', '$sce', '$state', '$uibModal', '$log',
    'mdService', 'doanhNghiepKeKhaiTemService', 'clientService', 'configService', '$filter', 'serviceInventoryAndWareHouse', 'serviceInventoryAndMerchandiseType', 'serviceInventoryAndMerchandise', 'serviceInventoryAndMerchandiseGroup', 'serviceInventoryAndCompany', 'serviceInventoryAndDonViHaiQuan', 'serviceInventoryAndUnitUser',
    function ($scope, $rootScope, $window, $stateParams, $timeout, $sce, $state, $uibModal, $log,
        ...
        function filterData() {
            ...
            doanhNghiepKeKhaiTemService.getNewParameter(function (response) {
        ...
        $scope.report = function () {
            ...
            $state.go('doanhNghiepKeKhaiTemReport', { obj: $scope.target });
        }
        $scope.printExcel = function () {
            doanhNghiepKeKhaiTemService.postExportExcel($scope.target, "BaoCaoKeKhaiTem");
        }
    }
]);
nvModule.controller('reportDoanhNghiepKeKhaiTemController', ['$scope', '$window', '$stateParams', '$timeout', '$state',
    'nvService', 'doanhNghiepKeKhaiTemService', 'mdService', 'clientService',
...
nvService, doanhNghiepKeKhaiTemService, mdService, clientService) {
    ...
    $scope.goIndex = function () {
        $state.go('doanhNghiepKeKhaiTem');
    }
    function filterData() {
        if (para) {
            doanhNghiepKeKhaiTemService.postReport(para, function (response) {
