acModule.factory('tienBanHangTrenMayBayService', [
    '$resource', '$http', '$window', 'configService', 'clientService',
    function ($resource, $http, $window, configService, clientService) {
        var rootUrl = configService.apiServiceBaseUri;
        var serviceUrl = configService.rootUrlWebApi + '/Ac/TienBanHangTrenMayBay';
        var calc = {
...
acModule.controller('tienBanHangTrenMayBayController', [
    '$scope', '$rootScope', '$window', '$stateParams', '$timeout', '$sce', '$state', '$uibModal', '$log',
    'mdService', 'tienBanHangTrenMayBayService', 'clientService', 'configService', '$filter', 'serviceInventoryAndWareHouse', 'serviceInventoryAndMerchandiseType', 'serviceInventoryAndMerchandise', 'serviceInventoryAndMerchandiseGroup', 'serviceInventoryAndCompany', 'serviceInventoryAndDonViHaiQuan', 'serviceInventoryAndUnitUser',
    function ($scope, $rootScope, $window, $stateParams, $timeout, $sce, $state, $uibModal, $log,
        mdService, tienBanHangTrenMayBayService, clientService, configService, $filter, serviceInventoryAndWareHouse, serviceInventoryAndMerchandiseType, serviceInventoryAndMerchandise, serviceInventoryAndMerchandiseGroup, serviceInventoryAndCompany, serviceInventoryAndDonViHaiQuan, serviceInventoryAndUnitUser) {
        $scope.tempData = mdService.tempData;
        $scope.robot = angular.copy(tienBanHangTrenMayBayService.robot);
        ...
        function filterData() {
            ...
            tienBanHangTrenMayBayService.getNewParameter(function (response) {
        ...
        $scope.report = function () {
            ...
            //tienBanHangTrenMayBayService.getReport($scope.target);
            $state.go('tienBanHangTrenMayBayReport', { obj: $scope.target });
        }

    }
]);
nvModule.controller('reportTienBanHangTrenMayBayController', ['$scope', '$window', '$stateParams', '$timeout', '$state',
    'nvService', 'tienBanHangTrenMayBayService', 'mdService', 'clientService',
...
nvService, tienBanHangTrenMayBayService, mdService, clientService) {
    ...
    $scope.goIndex = function () {
        $state.go('tienBanHangTrenMayBay');
    }
    function filterData() {
        if (para) {
            tienBanHangTrenMayBayService.postReport(para, function (response) {
    ...
    $scope.printExcel = function () {
        tienBanHangTrenMayBayService.postExportExcel($scope.target, "BaoCaoTienBanHangTrenMayBay");
    }
    filterData();
}]);
