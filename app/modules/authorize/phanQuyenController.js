authorizeModule.factory('phanQuyenService', [
    '$resource', '$http', '$window', 'configService', 'clientService',
    function ($resource, $http, $window, configService, clientService) {
        var serviceUrl = configService.rootUrlWebApi + '/Authorize/PhanQuyen';
        var result = {
...
service, configService, authorizeService) {
    ...
    function binData() {
        ...
        service.postQuery(JSON.stringify(postdata),
            function (response) {
