var DoanhNghiepKeKhaiTemService = nvModule.factory('DoanhNghiepKeKhaiTemService',
[
    '$resource', '$http', '$window', 'configService', 'clientService',
    function ($resource, $http, $window, configService, clientService) {
        var rootUrl = configService.apiServiceBaseUri;
        var serviceUrl = rootUrl + '/api/Nv/KeKhaiHangNhapKhoDn/DoanhNghiepKeKhaiTem';
...
var DoanhNghiepKeKhaiTemController = nvModule.controller('DoanhNghiepKeKhaiTemController', [
    '$scope', '$rootScope', '$location', '$window', '$uibModal', '$log', '$state', '$filter', '$http',
    'DoanhNghiepKeKhaiTemService', 'configService', 'clientService', 'nvService', 'mdService', 'serviceNhapHangAndMerchandise', '$mdDialog','localStorageService',
    function (
        $scope, $rootScope, $location, $window, $uibModal, $log, $state, $filter, $http,
        DoanhNghiepKeKhaiTemService, configService, clientService, nvService, mdService, serviceNhapHangAndMerchandise, $mdDialog,localStorageService) {
        ...
        $scope.title = function () {
            return 'Doanh nghiệp kê khai tem';
        };
        ...
        $scope.formatLabel = function (model, module, displayModel) {
            ...
            $scope.create = function() {
                ...
                var modalInstance = $uibModal.open({
                    backdrop: 'static',
                    templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'nvDoanhNghiepKeKhaiTem', 'add'),
                    controller: 'DoanhNghiepKeKhaiTemCreateController',
            ...
            $scope.details = function(target) {
                var modalInstance = $uibModal.open({
                    backdrop: 'static',
                    templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'nvDoanhNghiepKeKhaiTem', 'details'),
                    controller: 'DoanhNghiepKeKhaiTemDetailsController',
                    windowClass: 'app-modal-window',
                    //size: 'lg',
                    resolve: {
                        targetData: function() {
            ...
            $scope.printITem = function(target) {
                var modalInstance = $uibModal.open({
                    backdrop: 'static',
                    templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'nvDoanhNghiepKeKhaiTem', 'printItem'),
                    controller: 'DoanhNghiepKeKhaiTemExportItemController',
                    windowClass: 'app-modal-window',
                    resolve: {
                        targetData: function() {
                            return target;
            ...
            $scope.update = function(target) {
                var modalInstance = $uibModal.open({
                    backdrop: 'static',
                    templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'nvDoanhNghiepKeKhaiTem', 'update'),
                    controller: 'DoanhNghiepKeKhaiTemEditController',
                    windowClass: 'app-modal-window',
                    //size:'lg',
                    resolve: {
                        targetData: function() {
            ...
            $scope.print = function() {
                ...
                DoanhNghiepKeKhaiTemService.setParameterPrint(
                    postdata);
                $state.go("nvPrintDoanhNghiepKeKhaiTem");
            }
            $scope.printDetail = function() {
                ...
                DoanhNghiepKeKhaiTemService.setParameterPrint(
                    postdata);
                $state.go("nvPrintDetailDoanhNghiepKeKhaiTem");
            }
            ...
            $scope.deleteItem = function(ev, item) {
                ...
                $mdDialog.show(confirm).then(function() {
                    DoanhNghiepKeKhaiTemService.deleteItem(item).then(function(data) {
                        console.log(data);
                    }).then(function(data) {
                        $mdDialog.show(
                                $mdDialog.alert()
            ...
            $scope.import = function() {
                var modalInstance = $uibModal.open({
                    backdrop: 'static',
                    templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'nvDoanhNghiepKeKhaiTem', 'import'),
                    controller: 'DoanhNghiepKeKhaiTemImportController',
                    size: 'md'
                });
                modalInstance.result.then(function(updatedData) {
                    serviceNhapHangAndMerchandise.getSelectData().clear();
        ...
        function filterData() {
            ...
            var postdata = { paged: $scope.paged, filtered: $scope.filtered };
            DoanhNghiepKeKhaiTemService.postQuery(
...
nvModule.controller('DoanhNghiepKeKhaiTemDetailsController', [
'$scope', '$uibModalInstance',
'mdService', 'DoanhNghiepKeKhaiTemService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    ...
    $scope.title = function () {
        return 'Phiếu Doanh nghiệp kê khai tem';
    };
    ...
    $scope.approval = function () {
        DoanhNghiepKeKhaiTemService.postApproval($scope.target, function (response) {
            if (response) {

                alert("Duyệt thành công!");
                $uibModalInstance.close($scope.target);
                $scope.goIndex = function () {
                    $state.go('nvDoanhNghiepKeKhaiTem');
                };
    ...
    function fillterData() {
        $scope.isLoading = true;
        DoanhNghiepKeKhaiTemService.getDetails($scope.target.id, function (response) {
...
nvModule.controller('DoanhNghiepKeKhaiTemCreateController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log', 
    'nvService', 'DoanhNghiepKeKhaiTemService', 'mdService', 'configService', 'serviceNhapHangAndMerchandise', 'focus','$rootScope',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log,
        nvService, DoanhNghiepKeKhaiTemService, mdService, configService, serviceNhapHangAndMerchandise, focus, $rootScope) {
        $scope.robot = angular.copy(DoanhNghiepKeKhaiTemService.robot);
        $scope.paged = angular.copy(configService.pageDefault);
        $scope.config = nvService.config;
        $scope.tempData = mdService.tempData;
        $scope.newItem = {};
        ...
        $scope.addRow = function () {
            ...
            var exsist = $scope.target.dataDetails.some(function (element, index, array) {
                return $scope.newItem.maTem == element.maTem;
            });
            if (exsist) {
                ...
                //   DoanhNghiepKeKhaiTemService.robot.changeSoLuong($scope.target.dataDetails[k]);
                // }
                //});
            } else {
        ...
        $scope.selectedMaHang = function (code) {
            if (code) {
                DoanhNghiepKeKhaiTemService.getMerchandiseForNvByCode(code).then(function (response) {
        ...
        $scope.save = function () {
            $scope.Loading = true;
            DoanhNghiepKeKhaiTemService.post(
        ...
        function filterData() {
            $scope.isLoading = true;
            DoanhNghiepKeKhaiTemService.getNewInstance(function (response) {
...
nvModule.controller('DoanhNghiepKeKhaiTemEditController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log',
    'nvService', 'DoanhNghiepKeKhaiTemService', 'mdService', 'targetData', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log,
        nvService, DoanhNghiepKeKhaiTemService, mdService, targetData, configService, serviceNhapHangAndMerchandise, focus) {
        $scope.robot = angular.copy(DoanhNghiepKeKhaiTemService.robot);
        $scope.paged = angular.copy(configService.pageDefault);
        ...
        $scope.save = function () {
            DoanhNghiepKeKhaiTemService.updateCT($scope.target).then(
                    function (response) {
            ...
            DoanhNghiepKeKhaiTemService.updateCT($scope.target).then(
                    function (response) {
                        if (response.data.status) {
                            ...
                            var url = $state.href('reportDoanhNghiepKeKhaiTem', { id: response.data.data.id });
...
nvModule.controller('DoanhNghiepKeKhaiTemImportController', [
'$scope', '$uibModalInstance',
'mdService', 'DoanhNghiepKeKhaiTemService', 'clientService', 'configService', '$filter', 'Upload',
function ($scope, $uibModalInstance,
    mdService, DoanhNghiepKeKhaiTemService, clientService, configService, $filter, Upload) {
    $scope.config = mdService.config;
    $scope.title = function () {
        return 'Import Doanh nghiệp kê khai tem';
    };
...
nvModule.controller('reportDoanhNghiepKeKhaiTemConTroller', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state',
    'mdService', 'DoanhNghiepKeKhaiTemService', 'clientService',
    function ($scope, $filter, $window, $stateParams, $timeout, $state,
        ...
        function filterData() {
            if (id) {
                DoanhNghiepKeKhaiTemService.getReport(id, function (response) {
                    console.log(response);
                    if (response.status) {
                        $scope.target = response.data;
                    }
...
nvModule.controller('printDoanhNghiepKeKhaiTemController', [
    ...
    function($scope, $state, $window, $stateParams, $timeout, $filter,
        ...
        function filterData() {
            DoanhNghiepKeKhaiTemService.postPrint(
                function(response) {
                    $scope.printData = response;
                });
        };

        $scope.info = DoanhNghiepKeKhaiTemService.getParameterPrint().filtered.advanceData;
        $scope.goIndex = function() {
            $state.go("nvKeKhaiHangNhapKhoDn");
        }
        $scope.printExcel = function() {
...
nvModule.controller('printDetailDoanhNghiepKeKhaiTemController', [
    '$scope', '$state', '$window', '$stateParams', '$timeout', '$filter',
    'mdService', 'DoanhNghiepKeKhaiTemService', 'clientService',
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        mdService, DoanhNghiepKeKhaiTemService, clientService) {
        ...
        function filterData() {
            DoanhNghiepKeKhaiTemService.postPrintDetail(
                function (response) {
                    $scope.printData = response;
                });
        }
...
nvModule.controller('DoanhNghiepKeKhaiTemExportItemController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state',
    'mdService', 'DoanhNghiepKeKhaiTemService', 'clientService', '$uibModalInstance', 'targetData', 'Excel', 'configService', '$location',
    function ($scope, $filter, $window, $stateParams, $timeout, $state,
        mdService, DoanhNghiepKeKhaiTemService, clientService, $uibModalInstance, targetData, Excel, configService, $location) {
        $scope.config = mdService.config;
        $scope.title = function () {
        ...
        DoanhNghiepKeKhaiTemService.getUnitName($scope.maDonVi).then(function (response) {
            $scope.tenDonVi = response.data;
        });
        DoanhNghiepKeKhaiTemService.getInfoItemDetails($scope.target.id, function (response) {
            console.log(response);
            if (response.status) {
        ...
        $scope.exportToExcel = function () {
            DoanhNghiepKeKhaiTemService.writeDataToExcel($scope.dataHangHoa, function (response) {
                if (response.status) {
                    clientService.noticeAlert("Thành công", "success");
                    //  $uibModalInstance.close($scope.target);
                }
