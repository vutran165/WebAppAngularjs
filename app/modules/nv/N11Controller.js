var keKhaiNhapHangMauHangThuVaoChTuKhoService = nvModule.factory('keKhaiNhapHangMauHangThuVaoChTuKhoService',
[
    '$resource', '$http', '$window', 'configService', 'clientService',
    function ($resource, $http, $window, configService, clientService) {
        var rootUrl = configService.apiServiceBaseUri;
        var serviceUrl = rootUrl + '/api/Nv/KeKhaiHangNhapKhoDn/KeKhaiNhapHangMauHangThuVaoChTuKho';
...
var keKhaiNhapHangMauHangThuVaoChTuKhoController = nvModule.controller('keKhaiNhapHangMauHangThuVaoChTuKhoController', [
    '$scope', '$rootScope', '$location', '$window', '$uibModal', '$log', '$state', '$filter', '$http',
    'keKhaiNhapHangMauHangThuVaoChTuKhoService', 'configService', 'clientService', 'nvService', 'mdService', 'blockUI', 'serviceNhapHangAndMerchandise', '$mdDialog', 'localStorageService', 'authorizeService', 'serviceCompanySelected',
    function (
        $scope, $rootScope, $location, $window, $uibModal, $log, $state, $filter, $http,
        keKhaiNhapHangMauHangThuVaoChTuKhoService, configService, clientService, nvService, mdService, blockUI, serviceNhapHangAndMerchandise, $mdDialog, localStorageService, authorizeService, serviceCompanySelected
    ) {
        ...
        $scope.selectedCompany = function (code) {
            if (code) {
                keKhaiNhapHangMauHangThuVaoChTuKhoService.getSelectCompanyByCode(code).then(function (response) {
        ...
        $scope.title = function () {
            return 'Kê khai hàng mẫu hàng thử nhập vào cửa hàng từ phiếu xuất kho';
        };
        ...
        $scope.create = function () {
            ...
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangMauHangThuVaoChTuKho', 'add'),
                controller: 'keKhaiNhapHangMauHangThuVaoChTuKhoCreateController',
        ...
        $scope.details = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangMauHangThuVaoChTuKho', 'details'),
                controller: 'keKhaiNhapHangMauHangThuVaoChTuKhoDetailsController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.histories = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangMauHangThuVaoChTuKho', 'histories'),
                controller: 'keKhaiNhapHangMauHangThuVaoChTuKhoHistoryController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.printITem = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangMauHangThuVaoChTuKho', 'printItem'),
                controller: 'keKhaiNhapHangMauHangThuVaoChTuKhoExportItemController',
                windowClass: 'app-modal-window',
                resolve: {
                    targetData: function () {
                        return target;
        ...
        $scope.printPopup = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangMauHangThuVaoChTuKho', 'report'),
        ...
        $scope.update = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangMauHangThuVaoChTuKho', 'update'),
                controller: 'keKhaiNhapHangMauHangThuVaoChTuKhoEditController',
                windowClass: 'app-modal-window',
                //size:'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.print = function () {
            ...
            keKhaiNhapHangMauHangThuVaoChTuKhoService.setParameterPrint(
                postdata);
            $state.go("nvPrintkeKhaiNhapHangMauHangThuVaoChTuKho");
        }
        $scope.printDetail = function () {
            ...
            keKhaiNhapHangMauHangThuVaoChTuKhoService.setParameterPrint(
                postdata);
            $state.go("nvPrintDetailkeKhaiNhapHangMauHangThuVaoChTuKho");
        }
        ...
        $scope.deleteItem = function (ev, item) {
            ...
            $mdDialog.show(confirm).then(function () {
                keKhaiNhapHangMauHangThuVaoChTuKhoService.deleteItem(item).then(function (data) {
                    console.log(data);
                }).then(function (data) {
                    $mdDialog.show(
                            $mdDialog.alert()
        ...
        $scope.import = function () {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangMauHangThuVaoChTuKho', 'import'),
                controller: 'keKhaiNhapHangMauHangThuVaoChTuKhoImportController',
                size: 'md'
            });
            modalInstance.result.then(function (updatedData) {
                serviceNhapHangAndMerchandise.getSelectData().clear();
        ...
        function filterData() {
            ...
            var postdata = { paged: $scope.paged, filtered: $scope.filtered };
            keKhaiNhapHangMauHangThuVaoChTuKhoService.postQuery(
...
nvModule.controller('keKhaiNhapHangMauHangThuVaoChTuKhoDetailsController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiNhapHangMauHangThuVaoChTuKhoService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    ...
    $scope.approval = function () {
        keKhaiNhapHangMauHangThuVaoChTuKhoService.postApproval($scope.target, function (response) {
            if (response) {
                alert("Duyệt thành công!");
                $uibModalInstance.close($scope.target);
                $scope.goIndex = function () {
                    $state.go('nvKeKhaiHangMauHangThuVaoChTuKho');
                };
    ...
    function fillterData() {
        $scope.isLoading = true;
        keKhaiNhapHangMauHangThuVaoChTuKhoService.getDetails($scope.target.id, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiNhapHangMauHangThuVaoChTuKhoHistoryController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiNhapHangMauHangThuVaoChTuKhoService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    mdService, keKhaiNhapHangMauHangThuVaoChTuKhoService, targetData, clientService, configService, $filter) {
    ...
    function fillterData() {
        ...
        keKhaiNhapHangMauHangThuVaoChTuKhoService.getHistories(choiceObj, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiNhapHangMauHangThuVaoChTuKhoCreateController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log',
    'nvService', 'keKhaiNhapHangMauHangThuVaoChTuKhoService', 'mdService', 'configService', 'serviceNhapHangAndMerchandise', 'focus', '$resource',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log,
        nvService, keKhaiNhapHangMauHangThuVaoChTuKhoService, mdService, configService, serviceNhapHangAndMerchandise, focus, $resource) {
        var rootUrl = configService.apiServiceBaseUri;

        $scope.robot = angular.copy(keKhaiNhapHangMauHangThuVaoChTuKhoService.robot);
        $scope.paged = angular.copy(configService.pageDefault);
        $scope.config = nvService.config;
        $scope.tempData = mdService.tempData;
        $scope.newItem = {};
        ...
        $scope.selectedMaHang = function (code) {
            if (code) {
                keKhaiNhapHangMauHangThuVaoChTuKhoService.getMerchandiseForNvByCode(code).then(function (response) {
        ...
        $scope.save = function () {
            $scope.Loading = true;
            keKhaiNhapHangMauHangThuVaoChTuKhoService.post(
        ...
        function filterData() {
            $scope.isLoading = true;
            keKhaiNhapHangMauHangThuVaoChTuKhoService.getNewInstance(function (response) {
                ...
                //keKhaiNhapHangMauHangThuVaoChTuKhoService.getCurrentUser(function (response) {
...
nvModule.controller('keKhaiNhapHangMauHangThuVaoChTuKhoEditController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log',
    'nvService', 'keKhaiNhapHangMauHangThuVaoChTuKhoService', 'mdService', 'targetData', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log,
        nvService, keKhaiNhapHangMauHangThuVaoChTuKhoService, mdService, targetData, configService, serviceNhapHangAndMerchandise, focus) {
        $scope.robot = angular.copy(keKhaiNhapHangMauHangThuVaoChTuKhoService.robot);
        $scope.paged = angular.copy(configService.pageDefault);
        ...
        $scope.selectedkhachHang = function (item) {
            ...
            keKhaiNhapHangMauHangThuVaoChTuKhoService.getCustomer(item.id, function (response) {
        ...
        $scope.save = function () {
            keKhaiNhapHangMauHangThuVaoChTuKhoService.updateCT($scope.target).then(
                    function (response) {
            ...
            keKhaiNhapHangMauHangThuVaoChTuKhoService.updateCT($scope.target).then(
                    function (response) {
                        if (response.data.status) {
                            ...
                            var url = $state.href('reportkeKhaiNhapHangMauHangThuVaoChTuKho', { id: response.data.data.id });
...
nvModule.controller('reportKeKhaiNhapHangMauHangThuVaoChTuKhoController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state', 'targetData', '$uibModalInstance', '$rootScope',
    'mdService', 'keKhaiNhapHangMauHangThuVaoChTuKhoService', 'clientService',
    function ($scope, $filter, $window, $stateParams, $timeout, $state, targetData, $uibModalInstance, $rootScope,
        ...
        $scope.title = "PHIẾU KÊ KHAI HÀNG MẪU HÀNG THỬ NHẬP VÀO CỬA HÀNG TỪ PHIẾU XUẤT KHO";
        ...
        function filterData() {
            if (targetData.id) {
                keKhaiNhapHangMauHangThuVaoChTuKhoService.getReport(targetData.id, function (response) {
                    if (response.status) {
                        $scope.target = response.data;
...
nvModule.controller('printkeKhaiNhapHangMauHangThuVaoChTuKhoController', [
    ...
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        ...
        function filterData() {
            keKhaiNhapHangMauHangThuVaoChTuKhoService.postPrint(
                function (response) {
                    $scope.printData = response;
                });
        };

        $scope.info = keKhaiNhapHangMauHangThuVaoChTuKhoService.getParameterPrint().filtered.advanceData;
        $scope.goIndex = function () {
            $state.go("nvKeKhaiHangMauHangThuVaoChTuKho");
        }
        $scope.printExcel = function () {
...
nvModule.controller('printDetailkeKhaiNhapHangMauHangThuVaoChTuKhoController', [
    '$scope', '$state', '$window', '$stateParams', '$timeout', '$filter',
    'mdService', 'keKhaiNhapHangMauHangThuVaoChTuKhoService', 'clientService',
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        mdService, keKhaiNhapHangMauHangThuVaoChTuKhoService, clientService) {
        ...
        function filterData() {
            keKhaiNhapHangMauHangThuVaoChTuKhoService.postPrintDetail(
                function (response) {
                    $scope.printData = response;
                });
        }
...
nvModule.controller('keKhaiNhapHangMauHangThuVaoChTuKhoExportItemController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state',
    'mdService', 'keKhaiNhapHangMauHangThuVaoChTuKhoService', 'clientService', '$uibModalInstance', 'targetData', 'Excel', 'configService', '$location',
    function ($scope, $filter, $window, $stateParams, $timeout, $state,
        ...
        keKhaiNhapHangMauHangThuVaoChTuKhoService.getUnitName($scope.maDonVi).then(function (response) {
            $scope.tenDonVi = response.data;
        });
        keKhaiNhapHangMauHangThuVaoChTuKhoService.getInfoItemDetails($scope.target.id, function (response) {
            console.log(response);
            if (response.status) {
        ...
        $scope.exportToExcel = function () {
            keKhaiNhapHangMauHangThuVaoChTuKhoService.writeDataToExcel($scope.dataHangHoa, function (response) {
                if (response.status) {
                    clientService.noticeAlert("Thành công", "success");
                    //  $uibModalInstance.close($scope.target);
                }
