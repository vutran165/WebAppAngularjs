var keKhaiHangThuNhapVaoKhoDnTuCuaHangService = nvModule.factory('keKhaiHangThuNhapVaoKhoDnTuCuaHangService',
[
    '$resource', '$http', '$window', 'configService', 'clientService',
    function ($resource, $http, $window, configService, clientService) {
        var rootUrl = configService.apiServiceBaseUri;
        var serviceUrl = rootUrl + '/api/Nv/KeKhaiHangNhapKhoDn/KeKhaiHangThuNhapVaoKhoDnTuCuaHang';
...
var keKhaiHangThuNhapVaoKhoDnTuCuaHangController = nvModule.controller('keKhaiHangThuNhapVaoKhoDnTuCuaHangController', [
    '$scope', '$rootScope', '$location', '$window', '$uibModal', '$log', '$state', '$filter', '$http',
    'keKhaiHangThuNhapVaoKhoDnTuCuaHangService', 'configService', 'clientService', 'nvService', 'mdService', 'blockUI', 'serviceNhapHangAndMerchandise', '$mdDialog', 'localStorageService', 'authorizeService', 'serviceCompanySelected',
    function (
        $scope, $rootScope, $location, $window, $uibModal, $log, $state, $filter, $http,
        keKhaiHangThuNhapVaoKhoDnTuCuaHangService, configService, clientService, nvService, mdService, blockUI, serviceNhapHangAndMerchandise, $mdDialog, localStorageService, authorizeService, serviceCompanySelected) {
        ...
        $scope.selectedCompany = function (code) {
            if (code) {
                keKhaiHangThuNhapVaoKhoDnTuCuaHangService.getSelectCompanyByCode(code).then(function (response) {
        ...
        $scope.title = function () {
            return 'Kê khai hàng mẫu hàng thử nhập vào kho doanh nghiệp từ cửa hàng';
        };
        ...
        $scope.create = function () {
            ...
            var modalInstance = $uibModal.open({
                ...
                controller: 'keKhaiHangThuNhapVaoKhoDnTuCuaHangCreateController',
        ...
        $scope.details = function (target) {
            var modalInstance = $uibModal.open({
                ...
                controller: 'keKhaiHangThuNhapVaoKhoDnTuCuaHangDetailsController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.printITem = function (target) {
            var modalInstance = $uibModal.open({
                ...
                controller: 'keKhaiHangThuNhapVaoKhoDnTuCuaHangExportItemController',
                windowClass: 'app-modal-window',
                resolve: {
                    targetData: function () {
                        return target;
        ...
        $scope.update = function (target) {
            var modalInstance = $uibModal.open({
                ...
                controller: 'keKhaiHangThuNhapVaoKhoDnTuCuaHangEditController',
                windowClass: 'app-modal-window',
                //size:'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.print = function () {
            ...
            keKhaiHangThuNhapVaoKhoDnTuCuaHangService.setParameterPrint(
                postdata);
            $state.go("nvPrintkeKhaiHangThuNhapVaoKhoDnTuCuaHang");
        }
        $scope.printDetail = function () {
            ...
            keKhaiHangThuNhapVaoKhoDnTuCuaHangService.setParameterPrint(
                postdata);
            $state.go("nvPrintDetailkeKhaiHangThuNhapVaoKhoDnTuCuaHang");
        }
        ...
        $scope.deleteItem = function (ev, item) {
            ...
            $mdDialog.show(confirm).then(function () {
                keKhaiHangThuNhapVaoKhoDnTuCuaHangService.deleteItem(item).then(function (data) {
                    console.log(data);
                }).then(function (data) {
                    $mdDialog.show(
                            $mdDialog.alert()
        ...
        $scope.import = function () {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'nvkeKhaiHangThuNhapVaoKhoDnTuCuaHang', 'import'),
                controller: 'keKhaiHangThuNhapVaoKhoDnTuCuaHangImportController',
                size: 'md'
            });
            modalInstance.result.then(function (updatedData) {
                serviceNhapHangAndMerchandise.getSelectData().clear();
        ...
        function filterData() {
            ...
            var postdata = { paged: $scope.paged, filtered: $scope.filtered };
            keKhaiHangThuNhapVaoKhoDnTuCuaHangService.postQuery(
...
nvModule.controller('keKhaiHangThuNhapVaoKhoDnTuCuaHangDetailsController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangThuNhapVaoKhoDnTuCuaHangService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    ...
    $scope.approval = function () {
        keKhaiHangThuNhapVaoKhoDnTuCuaHangService.postApproval($scope.target, function (response) {
            if (response) {

                alert("Duyệt thành công!");
                $uibModalInstance.close($scope.target);
                $scope.goIndex = function () {
                    $state.go('nvkeKhaiHangThuNhapVaoKhoDnTuCuaHang');
                };
    ...
    function fillterData() {
        ...
        keKhaiHangThuNhapVaoKhoDnTuCuaHangService.getDetails($scope.target.id, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiHangThuNhapVaoKhoDnTuCuaHangHistoryController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangThuNhapVaoKhoDnTuCuaHangService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    mdService, keKhaiHangThuNhapVaoKhoDnTuCuaHangService, targetData, clientService, configService, $filter) {
    ...
    function fillterData() {
        ...
        keKhaiHangThuNhapVaoKhoDnTuCuaHangService.getHistories(choiceObj, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiHangThuNhapVaoKhoDnTuCuaHangCreateController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log', '$rootScope',
    'nvService', 'keKhaiHangThuNhapVaoKhoDnTuCuaHangService', 'mdService', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log, $rootScope,
        nvService, keKhaiHangThuNhapVaoKhoDnTuCuaHangService, mdService, configService, serviceNhapHangAndMerchandise, focus) {
        $scope.robot = angular.copy(keKhaiHangThuNhapVaoKhoDnTuCuaHangService.robot);
        $scope.paged = angular.copy(configService.pageDefault);
        $scope.config = nvService.config;
        $scope.tempData = mdService.tempData;
        $scope.newItem = {};
                ...
                if (exsist) {
                    ...
                    angular.forEach($scope.target.dataDetails, function (v, k) {
                        if (v.maHang == $scope.newItem.maHang && $scope.newItem.soToKhai == v.soToKhai) {
                            ...
                            keKhaiHangThuNhapVaoKhoDnTuCuaHangService.robot.changeSoLuong($scope.target.dataDetails[k]);
                        }
                    });
                } else {
        ...
        $scope.selectedMaHang = function (code) {
            if (code) {
                keKhaiHangThuNhapVaoKhoDnTuCuaHangService.getMerchandiseForNvByCode(code).then(function (response) {
        ...
        $scope.save = function () {
            ...
            $scope.Loading = true;
            keKhaiHangThuNhapVaoKhoDnTuCuaHangService.post(
        ...
        function filterData() {
            $scope.isLoading = true;
            keKhaiHangThuNhapVaoKhoDnTuCuaHangService.getNewInstance(function (response) {
                ...
                //keKhaiHangThuNhapVaoKhoDnTuCuaHangService.getCurrentUser(function (response) {
...
nvModule.controller('keKhaiHangThuNhapVaoKhoDnTuCuaHangEditController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log',
    'nvService', 'keKhaiHangThuNhapVaoKhoDnTuCuaHangService', 'mdService', 'targetData', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log,
        ...
        $scope.save = function () {
            keKhaiHangThuNhapVaoKhoDnTuCuaHangService.updateCT($scope.target).then(
                    function (response) {
            ...
            keKhaiHangThuNhapVaoKhoDnTuCuaHangService.updateCT($scope.target).then(
                    function (response) {
                        if (response.data.status) {
                            ...
                            var url = $state.href('reportkeKhaiHangThuNhapVaoKhoDnTuCuaHang', { id: response.data.data.id });
...
nvModule.controller('reportkeKhaiHangThuNhapVaoKhoDnTuCuaHangController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state', 'targetData', '$uibModalInstance', '$rootScope',
    'mdService', 'keKhaiHangThuNhapVaoKhoDnTuCuaHangService', 'clientService',
    function ($scope, $filter, $window, $stateParams, $timeout, $state, targetData, $uibModalInstance, $rootScope,
        ...
        $scope.title = "PHIẾU KÊ KHAI HÀNG MẪU HÀNG THỬ NHẬP VÀO KHO DOANH NGHIỆP TỪ CỬA HÀNG";
        ...
        function filterData() {
            if (targetData.id) {
                keKhaiHangThuNhapVaoKhoDnTuCuaHangService.getReport(targetData.id, function (response) {
                    console.log(response);
                    if (response.status) {
                        $scope.target = response.data;
...
nvModule.controller('printkeKhaiHangThuNhapVaoKhoDnTuCuaHangController', [
    ...
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        ...
        function filterData() {
            keKhaiHangThuNhapVaoKhoDnTuCuaHangService.postPrint(
                function (response) {
                    $scope.printData = response;
                });
        };

        $scope.info = keKhaiHangThuNhapVaoKhoDnTuCuaHangService.getParameterPrint().filtered.advanceData;
        $scope.goIndex = function () {
            $state.go("nvkeKhaiHangThuNhapVaoKhoDnTuCuaHang");
        }
        $scope.printExcel = function () {
...
nvModule.controller('printDetailkeKhaiHangThuNhapVaoKhoDnTuCuaHangController', [
    '$scope', '$state', '$window', '$stateParams', '$timeout', '$filter',
    'mdService', 'keKhaiHangThuNhapVaoKhoDnTuCuaHangService', 'clientService',
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        mdService, keKhaiHangThuNhapVaoKhoDnTuCuaHangService, clientService) {
        ...
        function filterData() {
            keKhaiHangThuNhapVaoKhoDnTuCuaHangService.postPrintDetail(
                function (response) {
                    $scope.printData = response;
                });
        }
...
nvModule.controller('keKhaiHangThuNhapVaoKhoDnTuCuaHangExportItemController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state',
    'mdService', 'keKhaiHangThuNhapVaoKhoDnTuCuaHangService', 'clientService', '$uibModalInstance', 'targetData', 'Excel', 'configService', '$location',
    function ($scope, $filter, $window, $stateParams, $timeout, $state,
        ...
        keKhaiHangThuNhapVaoKhoDnTuCuaHangService.getUnitName($scope.maDonVi).then(function (response) {
            $scope.tenDonVi = response.data;
        });
        keKhaiHangThuNhapVaoKhoDnTuCuaHangService.getInfoItemDetails($scope.target.id, function (response) {
            console.log(response);
            if (response.status) {
        ...
        $scope.exportToExcel = function () {
            keKhaiHangThuNhapVaoKhoDnTuCuaHangService.writeDataToExcel($scope.dataHangHoa, function (response) {
                if (response.status) {
                    clientService.noticeAlert("Thành công", "success");
                    //  $uibModalInstance.close($scope.target);
                }
