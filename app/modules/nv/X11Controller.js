var keKhaiHangHoaXuatTuKhoLenTauService = nvModule.factory('keKhaiHangHoaXuatTuKhoLenTauService',
[
    '$resource', '$http', '$window', 'configService', 'clientService',
    function ($resource, $http, $window, configService, clientService) {
        var rootUrl = configService.apiServiceBaseUri;
        var serviceUrl = rootUrl + '/api/Nv/XuatHangTuKhoLenTau/XuatHangTuKhoLenTau';
...
var keKhaiHangHoaXuatTuKhoLenTauController = nvModule.controller('keKhaiHangHoaXuatTuKhoLenTauController', [
    '$scope', '$rootScope', '$location', '$window', '$uibModal', '$log', '$state', '$filter', '$http',
    'keKhaiHangHoaXuatTuKhoLenTauService', 'configService', 'clientService', 'nvService', 'mdService', 'blockUI', 'serviceNhapHangAndMerchandise', '$mdDialog', 'localStorageService', 'authorizeService', 'serviceCompanySelected', function (
        $scope, $rootScope, $location, $window, $uibModal, $log, $state, $filter, $http,
        keKhaiHangHoaXuatTuKhoLenTauService, configService, clientService, nvService, mdService, blockUI, serviceNhapHangAndMerchandise, $mdDialog, localStorageService, authorizeService, serviceCompanySelected) {
        ...
        $scope.selectedCompany = function (code) {
            if (code) {
                keKhaiHangHoaXuatTuKhoLenTauService.getSelectCompanyByCode(code).then(function (response) {
        ...
        $scope.title = function () {
            return 'Kê khai hàng hóa xuất từ kho doanh nghiệp lên tàu bay';
        };
        ...
        $scope.create = function () {
            ...
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangHoaXuatTuKhoLenTau', 'add'),
                controller: 'keKhaiHangHoaXuatTuKhoLenTauCreateController',
        ...
        $scope.details = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangHoaXuatTuKhoLenTau', 'details'),
                controller: 'keKhaiHangHoaXuatTuKhoLenTauDetailsController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.printPopup = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangHoaXuatTuKhoLenTau', 'report'),
        ...
        $scope.histories = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangHoaXuatTuKhoLenTau', 'histories'),
                controller: 'keKhaiHangHoaXuatTuKhoLenTauHistoryController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.printITem = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangHoaXuatTuKhoLenTau', 'printItem'),
                controller: 'keKhaiHangHoaXuatTuKhoLenTauExportItemController',
                windowClass: 'app-modal-window',
                resolve: {
                    targetData: function () {
                        return target;
        ...
        $scope.update = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangHoaXuatTuKhoLenTau', 'update'),
                controller: 'keKhaiHangHoaXuatTuKhoLenTauEditController',
                windowClass: 'app-modal-window',
                //size:'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.print = function () {
            ...
            keKhaiHangHoaXuatTuKhoLenTauService.setParameterPrint(
                postdata);
            $state.go("nvPrintkeKhaiHangHoaXuatTuKhoLenTau");
        }
        $scope.printDetail = function () {
            ...
            keKhaiHangHoaXuatTuKhoLenTauService.setParameterPrint(
                postdata);
            $state.go("nvPrintDetailkeKhaiHangHoaXuatTuKhoLenTau");
        }
        ...
        $scope.deleteItem = function (ev, item) {
            ...
            $mdDialog.show(confirm).then(function () {
                keKhaiHangHoaXuatTuKhoLenTauService.deleteItem(item).then(function (data) {
                    console.log(data);
                }).then(function (data) {
                    $mdDialog.show(
                            $mdDialog.alert()
        ...
        function filterData() {
            ...
            var postdata = { paged: $scope.paged, filtered: $scope.filtered };
            keKhaiHangHoaXuatTuKhoLenTauService.postQuery(
...
nvModule.controller('keKhaiHangHoaXuatTuKhoLenTauDetailsController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangHoaXuatTuKhoLenTauService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    ...
    $scope.tempData = mdService.tempData;
    $scope.title = function () {
        return 'Phiếu kê khai hàng hóa xuất kho doanh nghiệp lên tàu bay';
    };
    ...
    $scope.approval = function () {
        keKhaiHangHoaXuatTuKhoLenTauService.postApproval($scope.target, function (response) {
            if (response) {
                alert("Duyệt thành công!");
                $uibModalInstance.close($scope.target);
                $scope.goIndex = function () {
                    $state.go('NvKeKhaiHangHoaXuatTuKhoLenTau');
                };
    ...
    function fillterData() {
        $scope.isLoading = true;
        keKhaiHangHoaXuatTuKhoLenTauService.getDetails($scope.target.id, function (response) {
            ...
            var dataWarehouse = $filter('filter')($scope.tempData.wareHouses, { value: $scope.target.maKhoXuat }, true);
            var store = $filter('filter')($scope.tempData.unitUsers, { value: $scope.target.maCuaHang }, true);
            if (data && dataCustom) {
                $scope.target.tenDoanhNghiep = data[0].description;
                $scope.target.tenHaiQuan = dataCustom[0].description;
                $scope.target.tenKhoXuat = dataWarehouse[0].description;
...
nvModule.controller('keKhaiHangHoaXuatTuKhoLenTauHistoryController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangHoaXuatTuKhoLenTauService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    mdService, keKhaiHangHoaXuatTuKhoLenTauService, targetData, clientService, configService, $filter) {
    ...
    function fillterData() {
        ...
        keKhaiHangHoaXuatTuKhoLenTauService.getHistories(choiceObj, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiHangHoaXuatTuKhoLenTauCreateController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log', '$rootScope',
    'nvService', 'keKhaiHangHoaXuatTuKhoLenTauService', 'mdService', 'configService', 'serviceNhapHangAndMerchandise', 'focus', '$resource',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log, $rootScope,
        nvService, keKhaiHangHoaXuatTuKhoLenTauService, mdService, configService, serviceNhapHangAndMerchandise, focus, $resource) {
        var rootUrl = configService.apiServiceBaseUri;

        $scope.robot = angular.copy(keKhaiHangHoaXuatTuKhoLenTauService.robot);
        $scope.paged = angular.copy(configService.pageDefault);
        $scope.config = nvService.config;
        $scope.tempData = mdService.tempData;
        $scope.newItem = {};
                ...
                if (exsist) {
                    ...
                    angular.forEach($scope.target.dataDetails, function (v, k) {
                        if (v.maHang == $scope.newItem.maHang && $scope.newItem.soToKhai == v.soToKhai) {
                            ...
                            keKhaiHangHoaXuatTuKhoLenTauService.robot.CalculatorThanhTien($scope.target.dataDetails[k]);
                        }
                    });
                } else {
        ...
        $scope.title = function () {
            return ' Phiếu kê khai hàng hóa xuất từ kho doanh nghiệp lên tàu bay';
        };
        $scope.selectedkhachHang = function (item) {
            $scope.target.maKhachHang = item.value;
            keKhaiHangHoaXuatTuKhoLenTauService.getOrderByCustomer(item.value, function (response) {
                $scope.donHangs = response;
            });
            keKhaiHangHoaXuatTuKhoLenTauService.getCustomer(item.id, function (response) {
        ...
        $scope.selectedMaHang = function (code) {
            if (code) {
                keKhaiHangHoaXuatTuKhoLenTauService.getMerchandiseForNvByCode(code).then(function (response) {
        ...
        $scope.selectedKhoNhap = function (item) {
            $scope.target.tenKhoNhap = item.text;
        };
        ...
        $scope.save = function () {
            $scope.Loading = true;
            keKhaiHangHoaXuatTuKhoLenTauService.post(
        ...
        function filterData() {
            $scope.isLoading = true;
            keKhaiHangHoaXuatTuKhoLenTauService.getNewInstance(function (response) {
                ...
                //keKhaiHangHoaXuatTuKhoLenTauService.getCurrentUser(function (response) {
...
nvModule.controller('keKhaiHangHoaXuatTuKhoLenTauEditController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log',
    'nvService', 'keKhaiHangHoaXuatTuKhoLenTauService', 'mdService', 'targetData', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log,
        ...
        $scope.save = function () {
            keKhaiHangHoaXuatTuKhoLenTauService.updateCT($scope.target).then(
                    function (response) {
            ...
            keKhaiHangHoaXuatTuKhoLenTauService.updateCT($scope.target).then(
                    function (response) {
                        if (response.data.status) {
                            ...
                            var url = $state.href('reportkeKhaiHangHoaXuatTuKhoLenTau', { id: response.data.data.id });
...
nvModule.controller('reportKeKhaiHangHoaXuatTuKhoLenTauController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state', 'targetData', '$uibModalInstance', '$rootScope',
    'mdService', 'keKhaiHangHoaXuatTuKhoLenTauService', 'clientService',
    function ($scope, $filter, $window, $stateParams, $timeout, $state, targetData, $uibModalInstance, $rootScope,
        ...
        function filterData() {
            if (targetData.id) {
                keKhaiHangHoaXuatTuKhoLenTauService.getReport(targetData.id, function (response) {
                    console.log(response);
                    if (response.status) {
                        $scope.target = response.data;
                    }
...
nvModule.controller('printkeKhaiHangHoaXuatTuKhoLenTauController', [
    ...
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        ...
        function filterData() {
            keKhaiHangHoaXuatTuKhoLenTauService.postPrint(
                function (response) {
                    $scope.printData = response;
                });
        };

        $scope.info = keKhaiHangHoaXuatTuKhoLenTauService.getParameterPrint().filtered.advanceData;
        $scope.goIndex = function () {
            $state.go("NvKeKhaiHangHoaXuatTuKhoLenTau");
        }
        $scope.printExcel = function () {
...
nvModule.controller('printDetailkeKhaiHangHoaXuatTuKhoLenTauController', [
    '$scope', '$state', '$window', '$stateParams', '$timeout', '$filter',
    'mdService', 'keKhaiHangHoaXuatTuKhoLenTauService', 'clientService',
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        mdService, keKhaiHangHoaXuatTuKhoLenTauService, clientService) {
        ...
        function filterData() {
            keKhaiHangHoaXuatTuKhoLenTauService.postPrintDetail(
                function (response) {
                    $scope.printData = response;
                });
        }
...
nvModule.controller('keKhaiHangHoaXuatTuKhoLenTauExportItemController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state',
    'mdService', 'keKhaiHangHoaXuatTuKhoLenTauService', 'clientService', '$uibModalInstance', 'targetData', 'Excel', 'configService', '$location',
    function ($scope, $filter, $window, $stateParams, $timeout, $state,
        ...
        keKhaiHangHoaXuatTuKhoLenTauService.getUnitName($scope.maDonVi).then(function (response) {
            $scope.tenDonVi = response.data;
        });
        keKhaiHangHoaXuatTuKhoLenTauService.getInfoItemDetails($scope.target.id, function (response) {
            console.log(response);
            if (response.status) {
        ...
        $scope.exportToExcel = function () {
            keKhaiHangHoaXuatTuKhoLenTauService.writeDataToExcel($scope.dataHangHoa, function (response) {
                if (response.status) {
                    clientService.noticeAlert("Thành công", "success");
                    //  $uibModalInstance.close($scope.target);
                }
