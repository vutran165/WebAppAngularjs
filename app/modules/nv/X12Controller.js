var keKhaiHangXuatTuTauBayVeKhoService = nvModule.factory('keKhaiHangXuatTuTauBayVeKhoService',
[
    '$resource', '$http', '$window', 'configService', 'clientService',
    function ($resource, $http, $window, configService, clientService) {
        var rootUrl = configService.apiServiceBaseUri;
        var serviceUrl = rootUrl + '/api/Nv/KeKhaiHangXuatKhoDn/XuatHangTuTauBayVeKho';
...
var keKhaiHangXuatTuTauBayVeKhoController = nvModule.controller('keKhaiHangXuatTuTauBayVeKhoController', [
    '$scope', '$rootScope', '$location', '$window', '$uibModal', '$log', '$state', '$filter', '$http',
    'keKhaiHangXuatTuTauBayVeKhoService', 'configService', 'clientService', 'nvService', 'mdService', 'blockUI', 'serviceNhapHangAndMerchandise', '$mdDialog', 'localStorageService', 'authorizeService', 'serviceCompanySelected', function (
        $scope, $rootScope, $location, $window, $uibModal, $log, $state, $filter, $http,
        keKhaiHangXuatTuTauBayVeKhoService, configService, clientService, nvService, mdService, blockUI, serviceNhapHangAndMerchandise, $mdDialog, localStorageService, authorizeService, serviceCompanySelected) {
        ...
        $scope.selectedCompany = function (code) {
            if (code) {
                keKhaiHangXuatTuTauBayVeKhoService.getSelectCompanyByCode(code).then(function (response) {
        ...
        $scope.title = function () {
            return 'Phiếu kê khai hàng hóa xuất từ tàu bay về kho doanh nghiệp';
        };
        ...
        $scope.create = function () {
            ...
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangXuatTuTauBayVeKho', 'add'),
                controller: 'keKhaiHangXuatTuTauBayVeKhoCreateController',
        ...
        $scope.details = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangXuatTuTauBayVeKho', 'details'),
                controller: 'keKhaiHangXuatTuTauBayVeKhoDetailsController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.printPopup = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangXuatTuTauBayVeKho', 'report'),
                controller: 'reportkeKhaiHangXuatTuTauBayVeKhoController',
                size: 'lg',
                resolve: {
                    targetData: function () {
                        return target;
        ...
        $scope.histories = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangXuatTuTauBayVeKho', 'histories'),
                controller: 'keKhaiHangXuatTuTauBayVeKhoHistoryController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.printITem = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangXuatTuTauBayVeKho', 'printItem'),
                controller: 'keKhaiHangXuatTuTauBayVeKhoExportItemController',
                windowClass: 'app-modal-window',
                resolve: {
                    targetData: function () {
                        return target;
        ...
        $scope.update = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangXuatTuTauBayVeKho', 'update'),
                controller: 'keKhaiHangXuatTuTauBayVeKhoEditController',
                windowClass: 'app-modal-window',
                //size:'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.print = function () {
            ...
            keKhaiHangXuatTuTauBayVeKhoService.setParameterPrint(
                postdata);
            $state.go("nvPrintkeKhaiHangXuatTuTauBayVeKho");
        }
        $scope.printDetail = function () {
            ...
            keKhaiHangXuatTuTauBayVeKhoService.setParameterPrint(
                postdata);
            $state.go("nvPrintDetailkeKhaiHangXuatTuTauBayVeKho");
        }
        ...
        $scope.deleteItem = function (ev, item) {
            ...
            $mdDialog.show(confirm).then(function () {
                keKhaiHangXuatTuTauBayVeKhoService.deleteItem(item).then(function (data) {
                    console.log(data);
                }).then(function (data) {
                    $mdDialog.show(
                            $mdDialog.alert()
        ...
        function filterData() {
            ...
            var postdata = { paged: $scope.paged, filtered: $scope.filtered };
            keKhaiHangXuatTuTauBayVeKhoService.postQuery(
...
nvModule.controller('keKhaiHangXuatTuTauBayVeKhoDetailsController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangXuatTuTauBayVeKhoService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    ...
    $scope.approval = function () {
        keKhaiHangXuatTuTauBayVeKhoService.postApproval($scope.target, function (response) {
            if (response) {
                alert("Duyệt thành công!");
                $uibModalInstance.close($scope.target);
                $scope.goIndex = function () {
                    $state.go('nvKeKhaiHangXuatTuTauBayVeKho');
                };
    ...
    function fillterData() {
        $scope.isLoading = true;
        keKhaiHangXuatTuTauBayVeKhoService.getDetails($scope.target.id, function (response) {
...
nvModule.controller('keKhaiHangXuatTuTauBayVeKhoHistoryController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangXuatTuTauBayVeKhoService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    mdService, keKhaiHangXuatTuTauBayVeKhoService, targetData, clientService, configService, $filter) {
    ...
    function fillterData() {
        ...
        keKhaiHangXuatTuTauBayVeKhoService.getHistories(choiceObj, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiHangXuatTuTauBayVeKhoCreateController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log', '$rootScope',
    'nvService', 'keKhaiHangXuatTuTauBayVeKhoService', 'mdService', 'configService', 'serviceNhapHangAndMerchandise', 'focus', '$resource',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log, $rootScope,
        nvService, keKhaiHangXuatTuTauBayVeKhoService, mdService, configService, serviceNhapHangAndMerchandise, focus, $resource) {
        var rootUrl = configService.apiServiceBaseUri;

        $scope.robot = angular.copy(keKhaiHangXuatTuTauBayVeKhoService.robot);
        $scope.paged = angular.copy(configService.pageDefault);
        $scope.config = nvService.config;
        $scope.tempData = mdService.tempData;
        $scope.newItem = {};
                ...
                if (exsist) {
                    ...
                    angular.forEach($scope.target.dataDetails, function (v, k) {
                        if (v.maHang == $scope.newItem.maHang && $scope.newItem.soToKhai == v.soToKhai) {
                            ...
                            keKhaiHangXuatTuTauBayVeKhoService.robot.CalculatorThanhTien($scope.target.dataDetails[k]);
                        }
                    });
                } else {
        ...
        $scope.selectedMaHang = function (code) {
            if (code) {
                keKhaiHangXuatTuTauBayVeKhoService.getMerchandiseForNvByCode(code).then(function (response) {
        ...
        $scope.save = function () {
            $scope.Loading = true;
            keKhaiHangXuatTuTauBayVeKhoService.post(
        ...
        function filterData() {
            $scope.isLoading = true;
            keKhaiHangXuatTuTauBayVeKhoService.getNewInstance(function (response) {
                ...
                //keKhaiHangXuatTuTauBayVeKhoService.getCurrentUser(function (response) {
...
nvModule.controller('keKhaiHangXuatTuTauBayVeKhoEditController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log',
    'nvService', 'keKhaiHangXuatTuTauBayVeKhoService', 'mdService', 'targetData', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log,
        ...
        $scope.selectedkhachHang = function (item) {
            ...
            keKhaiHangXuatTuTauBayVeKhoService.getCustomer(item.id, function (response) {
                $scope.target.maSoThue = response.maSoThue;
            });
        };
        $scope.selectedkhachHang = function (item) {
            $scope.target.maKhachHang = item.value;
            keKhaiHangXuatTuTauBayVeKhoService.getOrderByCustomer(item.value, function (response) {
        ...
        $scope.save = function () {
            keKhaiHangXuatTuTauBayVeKhoService.updateCT($scope.target).then(
                    function (response) {
...
nvModule.controller('reportkeKhaiHangXuatTuTauBayVeKhoController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state', 'targetData', '$uibModalInstance', '$rootScope',
    'mdService', 'keKhaiHangXuatTuTauBayVeKhoService', 'clientService',
    function ($scope, $filter, $window, $stateParams, $timeout, $state, targetData, $uibModalInstance, $rootScope,
        ...
        function filterData() {
            if (targetData.id) {
                keKhaiHangXuatTuTauBayVeKhoService.getReport(targetData.id, function (response) {
                    if (response.status) {
                        $scope.target = response.data;
...
nvModule.controller('printkeKhaiHangXuatTuTauBayVeKhoController', [
    ...
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        ...
        function filterData() {
            keKhaiHangXuatTuTauBayVeKhoService.postPrint(
                function (response) {
                    $scope.printData = response;
                });
        };

        $scope.info = keKhaiHangXuatTuTauBayVeKhoService.getParameterPrint().filtered.advanceData;
        $scope.goIndex = function () {
            $state.go("nvKeKhaiHangXuatTuTauBayVeKho");
        }
        $scope.printExcel = function () {
...
nvModule.controller('printDetailkeKhaiHangXuatTuTauBayVeKhoController', [
    '$scope', '$state', '$window', '$stateParams', '$timeout', '$filter',
    'mdService', 'keKhaiHangXuatTuTauBayVeKhoService', 'clientService',
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        mdService, keKhaiHangXuatTuTauBayVeKhoService, clientService) {
        ...
        function filterData() {
            keKhaiHangXuatTuTauBayVeKhoService.postPrintDetail(
                function (response) {
                    $scope.printData = response;
                });
        }
...
nvModule.controller('keKhaiHangXuatTuTauBayVeKhoExportItemController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state',
    'mdService', 'keKhaiHangXuatTuTauBayVeKhoService', 'clientService', '$uibModalInstance', 'targetData', 'Excel', 'configService', '$location',
    function ($scope, $filter, $window, $stateParams, $timeout, $state,
        ...
        keKhaiHangXuatTuTauBayVeKhoService.getUnitName($scope.maDonVi).then(function (response) {
            $scope.tenDonVi = response.data;
        });
        keKhaiHangXuatTuTauBayVeKhoService.getInfoItemDetails($scope.target.id, function (response) {
            console.log(response);
            if (response.status) {
        ...
        $scope.exportToExcel = function () {
            keKhaiHangXuatTuTauBayVeKhoService.writeDataToExcel($scope.dataHangHoa, function (response) {
                if (response.status) {
                    clientService.noticeAlert("Thành công", "success");
                    //  $uibModalInstance.close($scope.target);
                }
