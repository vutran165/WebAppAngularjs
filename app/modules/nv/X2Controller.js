var keKhaiHangHoaXuatTuKhoDnSangTxService = nvModule.factory('keKhaiHangHoaXuatTuKhoDnSangTxService',
[
    '$resource', '$http', '$window', 'configService', 'clientService',
    function ($resource, $http, $window, configService, clientService) {
        var rootUrl = configService.apiServiceBaseUri;
        var serviceUrl = rootUrl + '/api/Nv/KeKhaiHangXuatKhoDn/NvKeKhaiHangXuatTuKhoDnSangTx';
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnSangTxController', [
    '$scope', '$rootScope', '$location', '$window', '$uibModal', '$log', '$state', '$filter', '$http',
    'keKhaiHangHoaXuatTuKhoDnSangTxService', 'configService', 'clientService', 'nvService', 'mdService', 'companyService', '$mdDialog', 'localStorageService', 'authorizeService', 'serviceCompanySelected',
    function (
        $scope, $rootScope, $location, $window, $uibModal, $log, $state, $filter, $http,
        keKhaiHangHoaXuatTuKhoDnSangTxService, configService, clientService, nvService, mdService, companyService, $mdDialog, localStorageService, authorizeService, serviceCompanySelected
    ) {
        ...
        function filterData() {
            ...
            keKhaiHangHoaXuatTuKhoDnSangTxService.postQuery(JSON.stringify(postdata), function (response) {
        ...
        $scope.title = function () {
            return 'Kê khai hàng hóa xuất từ kho doanh nghiệp sang loại hình tái xuất';
        };
        ...
        $scope.create = function () {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangHoaXuatTuKhoDnSangTx', 'add'),
                controller: 'keKhaiHangHoaXuatTuKhoDnSangTxCreateController',
        ...
        $scope.details = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangHoaXuatTuKhoDnSangTx', 'details'),
                controller: 'keKhaiHangHoaXuatTuKhoDnSangTxDetailsController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.histories = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangHoaXuatTuKhoDnSangTx', 'histories'),
                controller: 'keKhaiHangHoaXuatTuKhoDnSangTxHistoryController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.printITem = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangHoaXuatTuKhoDnSangTx', 'printItem'),
                controller: 'keKhaiHangHoaXuatTuKhoDnSangTxExportItemController',
                windowClass: 'app-modal-window',
                resolve: {
                    targetData: function () {
                        return target;
        ...
        $scope.printPopup = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangHoaXuatTuKhoDnSangTx', 'report'),
        ...
        $scope.update = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangHoaXuatTuKhoDnSangTx', 'update'),
                controller: 'keKhaiHangHoaXuatTuKhoDnSangTxEditController',
                windowClass: 'app-modal-window',
                //size:'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.print = function () {
            ...
            keKhaiHangHoaXuatTuKhoDnSangTxService.setParameterPrint(
                postdata);
            $state.go("nvPrintkeKhaiHangHoaXuatTuKhoDnSangTx");
        }
        $scope.printDetail = function () {
            var postdata = { paged: $scope.paged, filtered: $scope.filtered };
            keKhaiHangHoaXuatTuKhoDnSangTxService.setParameterPrint(postdata);
            $state.go("nvPrintDetailkeKhaiHangHoaXuatTuKhoDnSangTx");
        }
        ...
        $scope.deleteItem = function (ev, item) {
            ...
            $mdDialog.show(confirm).then(function () {
                keKhaiHangHoaXuatTuKhoDnSangTxService.deleteItem(item).then(function (data) {
                    console.log(data);
                }).then(function (data) {
                    $mdDialog.show(
                            $mdDialog.alert()
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnSangTxDetailsController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangHoaXuatTuKhoDnSangTxService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    ...
    $scope.tempData = mdService.tempData;
    $scope.title = function () {
        return 'Phiếu kê khai hàng hóa xuất từ kho doanh nghiệp sang loại hình tái xuất';
    };
    ...
    $scope.approval = function () {
        keKhaiHangHoaXuatTuKhoDnSangTxService.postApproval($scope.target, function (response) {
            if (response) {

                alert("Duyệt thành công!");
                $uibModalInstance.close($scope.target);
                $scope.goIndex = function () {
                    $state.go('nvkeKhaiHangHoaXuatTuKhoDnSangTx');
                };
    ...
    function fillterData() {
        $scope.isLoading = true;
        keKhaiHangHoaXuatTuKhoDnSangTxService.getDetails($scope.target.id, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnSangTxHistoryController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangHoaXuatTuKhoDnSangTxService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    mdService, keKhaiHangHoaXuatTuKhoDnSangTxService, targetData, clientService, configService, $filter) {
    ...
    function fillterData() {
        ...
        keKhaiHangHoaXuatTuKhoDnSangTxService.getHistories(choiceObj, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnSangTxCreateController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log', '$rootScope',
    'nvService', 'keKhaiHangHoaXuatTuKhoDnSangTxService', 'mdService', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log, $rootScope,
        nvService, keKhaiHangHoaXuatTuKhoDnSangTxService, mdService, configService, serviceNhapHangAndMerchandise, focus) {
        $scope.robot = angular.copy(keKhaiHangHoaXuatTuKhoDnSangTxService.robot);
        $scope.paged = angular.copy(configService.pageDefault);
        $scope.config = nvService.config;
        $scope.tempData = mdService.tempData;
        $scope.newItem = {};
        ...
        $scope.selectedMaHang = function (code) {
            if (code) {
                keKhaiHangHoaXuatTuKhoDnSangTxService.getMerchandiseForNvByCode(code).then(function (response) {
        ...
        $scope.save = function () {
            $scope.Loading = true;
            keKhaiHangHoaXuatTuKhoDnSangTxService.post(
        ...
        function filterData() {
            $scope.isLoading = true;
            keKhaiHangHoaXuatTuKhoDnSangTxService.getNewInstance(function (response) {
                ...
                //keKhaiHangHoaXuatTuKhoDnSangTxService.getCurrentUser(function (response) {
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnSangTxEditController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log',
    'nvService', 'keKhaiHangHoaXuatTuKhoDnSangTxService', 'mdService', 'targetData', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log,
        ...
        $scope.title = function () {
            return 'Phiếu kê khai hàng hóa từ kho doanh nghiệp sang loại hình tái xuất';
        };

        $scope.selectedkhachHang = function (item) {
            $scope.target.maKhachHang = item.value;
            keKhaiHangHoaXuatTuKhoDnSangTxService.getCustomer(item.id, function (response) {
                $scope.target.maSoThue = response.maSoThue;
            });
        };
        // $scope.selectedkhachHang = function (item) {
        // $scope.target.maKhachHang = item.value;
        // keKhaiHangHoaXuatTuKhoDnSangTxService.getOrderByCustomer(item.value, function (response) {
        ...
        $scope.save = function () {
            keKhaiHangHoaXuatTuKhoDnSangTxService.updateCT($scope.target).then(
                    function (response) {
            ...
            keKhaiHangHoaXuatTuKhoDnSangTxService.updateCT($scope.target).then(
                    function (response) {
                        if (response.data.status) {
                            ...
                            var url = $state.href('reportkeKhaiHangHoaXuatTuKhoDnSangTx', { id: response.data.data.id });
...
nvModule.controller('reportkeKhaiHangHoaXuatTuKhoDnSangTxController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state', 'targetData', '$uibModalInstance', '$rootScope',
    'mdService', 'keKhaiHangHoaXuatTuKhoDnSangTxService', 'clientService',
    function ($scope, $filter, $window, $stateParams, $timeout, $state, targetData, $uibModalInstance, $rootScope,
        ...
        function filterData() {
            if (targetData.id) {
                keKhaiHangHoaXuatTuKhoDnSangTxService.getReport(targetData.id, function (response) {
                    if (response.status) {
                        $scope.target = response.data;
...
nvModule.controller('printkeKhaiHangHoaXuatTuKhoDnSangTxController', [
    ...
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        ...
        function filterData() {
            keKhaiHangHoaXuatTuKhoDnSangTxService.postPrint(
                function (response) {
                    $scope.printData = response;
                });
        };

        $scope.info = keKhaiHangHoaXuatTuKhoDnSangTxService.getParameterPrint().filtered.advanceData;
        $scope.goIndex = function () {
            $state.go("nvkeKhaiHangHoaXuatTuKhoDnSangTx");
        }
        $scope.printExcel = function () {
...
nvModule.controller('printDetailkeKhaiHangHoaXuatTuKhoDnSangTxController', [
    '$scope', '$state', '$window', '$stateParams', '$timeout', '$filter',
    'mdService', 'keKhaiHangHoaXuatTuKhoDnSangTxService', 'clientService',
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        mdService, keKhaiHangHoaXuatTuKhoDnSangTxService, clientService) {
        ...
        function filterData() {
            keKhaiHangHoaXuatTuKhoDnSangTxService.postPrintDetail(
                function (response) {
                    $scope.printData = response;
                });
        }
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnSangTxExportItemController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state',
    'mdService', 'keKhaiHangHoaXuatTuKhoDnSangTxService', 'clientService', '$uibModalInstance', 'targetData', 'Excel', 'configService', '$location',
    function ($scope, $filter, $window, $stateParams, $timeout, $state,
        ...
        keKhaiHangHoaXuatTuKhoDnSangTxService.getUnitName($scope.maDonVi).then(function (response) {
            $scope.tenDonVi = response.data;
        });
        keKhaiHangHoaXuatTuKhoDnSangTxService.getInfoItemDetails($scope.target.id, function (response) {
        ...
        $scope.exportToExcel = function () {
            keKhaiHangHoaXuatTuKhoDnSangTxService.writeDataToExcel($scope.dataHangHoa, function (response) {
                if (response.status) {
                    clientService.noticeAlert("Thành công", "success");
                    //  $uibModalInstance.close($scope.target);
                }
