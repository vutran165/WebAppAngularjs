nvModule.factory('keKhaiHangHoaXuatTuKhoDnChuyenNdService',
[
    '$resource', '$http', '$window', 'configService', 'clientService',
    function ($resource, $http, $window, configService, clientService) {
        var rootUrl = configService.apiServiceBaseUri;
        var serviceUrl = rootUrl + '/api/Nv/KeKhaiHangXuatKhoDn/NvKeKhaiHangXuatKhoDnChuyenNd';
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnChuyenNdController', [
    '$scope', '$rootScope', '$location', '$window', '$uibModal', '$log', '$state', '$filter', '$http',
    'keKhaiHangHoaXuatTuKhoDnChuyenNdService', 'configService', 'clientService', 'nvService', 'mdService', 'companyService', '$mdDialog', 'localStorageService', 'authorizeService', 'serviceCompanySelected',
    function (
        $scope, $rootScope, $location, $window, $uibModal, $log, $state, $filter, $http,
        keKhaiHangHoaXuatTuKhoDnChuyenNdService, configService, clientService, nvService, mdService, companyService, $mdDialog, localStorageService, authorizeService, serviceCompanySelected
    ) {
        ...
        function filterData() {
            ...
            keKhaiHangHoaXuatTuKhoDnChuyenNdService.postQuery(JSON.stringify(postdata), function (response) {
        ...
        $scope.title = function () {
            return 'Phiếu kê khai hàng hóa xuất từ kho doanh nghiệp chuyển tiêu thụ nội địa';
        };
        ...
        $scope.create = function () {
            ...
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvkeKhaiHangHoaXuatTuKhoDnChuyenNd', 'add'),
                controller: 'keKhaiHangHoaXuatTuKhoDnChuyenNdCreateController',
        ...
        $scope.details = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvkeKhaiHangHoaXuatTuKhoDnChuyenNd', 'details'),
                controller: 'keKhaiHangHoaXuatTuKhoDnChuyenNdDetailsController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.histories = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvkeKhaiHangHoaXuatTuKhoDnChuyenNd', 'histories'),
                controller: 'keKhaiHangHoaXuatTuKhoDnChuyenNdHistoryController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.printITem = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvkeKhaiHangHoaXuatTuKhoDnChuyenNd', 'printItem'),
                controller: 'keKhaiHangHoaXuatTuKhoDnChuyenNdExportItemController',
                windowClass: 'app-modal-window',
                resolve: {
                    targetData: function () {
                        return target;
        ...
        $scope.printPopup = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvkeKhaiHangHoaXuatTuKhoDnChuyenNd', 'report'),
        ...
        $scope.update = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvkeKhaiHangHoaXuatTuKhoDnChuyenNd', 'update'),
                controller: 'keKhaiHangHoaXuatTuKhoDnChuyenNdEditController',
                windowClass: 'app-modal-window',
                //size:'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.print = function () {
            ...
            keKhaiHangHoaXuatTuKhoDnChuyenNdService.setParameterPrint(
                postdata);
            $state.go("nvPrintkeKhaiHangHoaXuatTuKhoDnChuyenNd");
        }
        $scope.printDetail = function () {
            ...
            keKhaiHangHoaXuatTuKhoDnChuyenNdService.setParameterPrint(
                postdata);
            $state.go("nvPrintDetailkeKhaiHangHoaXuatTuKhoDnChuyenNd");
        }
        ...
        $scope.deleteItem = function (ev, item) {
            ...
            $mdDialog.show(confirm).then(function () {
                keKhaiHangHoaXuatTuKhoDnChuyenNdService.deleteItem(item).then(function (data) {
                    console.log(data);
                }).then(function (data) {
                    $mdDialog.show(
                            $mdDialog.alert()
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnChuyenNdDetailsController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangHoaXuatTuKhoDnChuyenNdService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    ...
    $scope.displayCompany = function (model, module) {
        if (!model) return "";
        var data = $filter('filter')(mdService.tempData[module], { value: model }, true);
        if (data && data.length == 1) {
            return data[0].description;
    ...
    $scope.approval = function () {
        keKhaiHangHoaXuatTuKhoDnChuyenNdService.postApproval($scope.target, function (response) {
            if (response) {

                alert("Duyệt thành công!");
                $uibModalInstance.close($scope.target);
                $scope.goIndex = function () {
                    $state.go('nvkeKhaiHangHoaXuatTuKhoDnChuyenNd');
                };
    ...
    function fillterData() {
        $scope.isLoading = true;
        keKhaiHangHoaXuatTuKhoDnChuyenNdService.getDetails($scope.target.id, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnChuyenNdHistoryController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangHoaXuatTuKhoDnChuyenNdService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    mdService, keKhaiHangHoaXuatTuKhoDnChuyenNdService, targetData, clientService, configService, $filter) {
    ...
    function fillterData() {
        ...
        keKhaiHangHoaXuatTuKhoDnChuyenNdService.getHistories(choiceObj, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnChuyenNdCreateController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log', '$rootScope',
    'nvService', 'keKhaiHangHoaXuatTuKhoDnChuyenNdService', 'mdService', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log, $rootScope,
        nvService, keKhaiHangHoaXuatTuKhoDnChuyenNdService, mdService, configService, serviceNhapHangAndMerchandise, focus) {
        $scope.robot = angular.copy(keKhaiHangHoaXuatTuKhoDnChuyenNdService.robot);
        $scope.paged = angular.copy(configService.pageDefault);
        $scope.config = nvService.config;
        $scope.tempData = mdService.tempData;
        $scope.newItem = {};
        ...
        $scope.selectedMaHang = function (code) {
            if (code) {
                keKhaiHangHoaXuatTuKhoDnChuyenNdService.getMerchandiseForNvByCode(code).then(function (response) {
        ...
        $scope.save = function () {
            $scope.Loading = true;
            keKhaiHangHoaXuatTuKhoDnChuyenNdService.post(
        ...
        function filterData() {
            $scope.isLoading = true;
            keKhaiHangHoaXuatTuKhoDnChuyenNdService.getNewInstance(function (response) {
                ...
                //get current user in here
                //keKhaiHangHoaXuatTuKhoDnChuyenNdService.getCurrentUser(function (response) {
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnChuyenNdEditController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log',
    'nvService', 'keKhaiHangHoaXuatTuKhoDnChuyenNdService', 'mdService', 'targetData', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log,
        ...
        $scope.save = function () {
            keKhaiHangHoaXuatTuKhoDnChuyenNdService.updateCT($scope.target).then(
                    function (response) {
            ...
            keKhaiHangHoaXuatTuKhoDnChuyenNdService.updateCT($scope.target).then(
                    function (response) {
                        if (response.data.status) {
                            ...
                            var url = $state.href('reportkeKhaiHangHoaXuatTuKhoDnChuyenNd', { id: response.data.data.id });
...
nvModule.controller('reportkeKhaiHangHoaXuatTuKhoDnChuyenNdController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state', 'targetData', '$uibModalInstance', '$rootScope',
    'mdService', 'keKhaiHangHoaXuatTuKhoDnChuyenNdService', 'clientService',
    function ($scope, $filter, $window, $stateParams, $timeout, $state, targetData, $uibModalInstance, $rootScope,
        ...
        function filterData() {
            if (targetData.id) {
                keKhaiHangHoaXuatTuKhoDnChuyenNdService.getReport(targetData.id, function (response) {
...
nvModule.controller('printkeKhaiHangHoaXuatTuKhoDnChuyenNdController', [
    ...
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        ...
        function filterData() {
            keKhaiHangHoaXuatTuKhoDnChuyenNdService.postPrint(
                function (response) {
                    $scope.printData = response;
                });
        };

        $scope.info = keKhaiHangHoaXuatTuKhoDnChuyenNdService.getParameterPrint().filtered.advanceData;
        $scope.goIndex = function () {
            $state.go("nvKeKhaiHangHoaXuatTuKhoDnChuyenNd");
        }
        $scope.printExcel = function () {
...
nvModule.controller('printDetailkeKhaiHangHoaXuatTuKhoDnChuyenNdController', [
    '$scope', '$state', '$window', '$stateParams', '$timeout', '$filter',
    'mdService', 'keKhaiHangHoaXuatTuKhoDnChuyenNdService', 'clientService',
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        mdService, keKhaiHangHoaXuatTuKhoDnChuyenNdService, clientService) {
        ...
        function filterData() {
            keKhaiHangHoaXuatTuKhoDnChuyenNdService.postPrintDetail(
                function (response) {
                    $scope.printData = response;
                });
        }
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnChuyenNdExportItemController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state',
    'mdService', 'keKhaiHangHoaXuatTuKhoDnChuyenNdService', 'clientService', '$uibModalInstance', 'targetData', 'Excel', 'configService', '$location',
    function ($scope, $filter, $window, $stateParams, $timeout, $state,
        ...
        keKhaiHangHoaXuatTuKhoDnChuyenNdService.getUnitName($scope.maDonVi).then(function (response) {
            $scope.tenDonVi = response.data;
        });
        keKhaiHangHoaXuatTuKhoDnChuyenNdService.getInfoItemDetails($scope.target.id, function (response) {
            console.log(response);
            if (response.status) {
        ...
        $scope.exportToExcel = function () {
            keKhaiHangHoaXuatTuKhoDnChuyenNdService.writeDataToExcel($scope.dataHangHoa, function (response) {
                if (response.status) {
                    clientService.noticeAlert("Thành công", "success");
                    //  $uibModalInstance.close($scope.target);
                }
