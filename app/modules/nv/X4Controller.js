nvModule.factory('keKhaiHangHoaXuatTuKhoDnSangTnService',
[
    '$resource', '$http', '$window', 'configService', 'clientService',
    function ($resource, $http, $window, configService, clientService) {
        var rootUrl = configService.apiServiceBaseUri;
        var serviceUrl = rootUrl + '/api/Nv/KeKhaiHangXuatKhoDn/NvKeKhaiHangXuatKhoDnSangTn';
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnSangTnController', [
    '$scope', '$rootScope', '$location', '$window', '$uibModal', '$log', '$state', '$filter', '$http',
    'keKhaiHangHoaXuatTuKhoDnSangTnService', 'configService', 'clientService', 'nvService', 'mdService', 'companyService', '$mdDialog', 'localStorageService', 'authorizeService', 'serviceCompanySelected',
    function (
        $scope, $rootScope, $location, $window, $uibModal, $log, $state, $filter, $http,
        keKhaiHangHoaXuatTuKhoDnSangTnService, configService, clientService, nvService, mdService, companyService, $mdDialog, localStorageService, authorizeService, serviceCompanySelected
    ) {
        ...
        function filterData() {
            ...
            keKhaiHangHoaXuatTuKhoDnSangTnService.postQuery(JSON.stringify(postdata), function (response) {
        ...
        $scope.title = function () {
            return 'Kê khai hàng hóa xuất từ kho doanh nghiệp sang loại hình tái nhập';
        };
        ...
        $scope.create = function () {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvkeKhaiHangHoaXuatTuKhoDnSangTn', 'add'),
                controller: 'keKhaiHangHoaXuatTuKhoDnSangTnCreateController',
        ...
        $scope.details = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvkeKhaiHangHoaXuatTuKhoDnSangTn', 'details'),
                controller: 'keKhaiHangHoaXuatTuKhoDnSangTnDetailsController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.histories = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvkeKhaiHangHoaXuatTuKhoDnSangTn', 'histories'),
                controller: 'keKhaiHangHoaXuatTuKhoDnSangTnHistoryController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.printITem = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvkeKhaiHangHoaXuatTuKhoDnSangTn', 'printItem'),
                controller: 'keKhaiHangHoaXuatTuKhoDnSangTnExportItemController',
                windowClass: 'app-modal-window',
                resolve: {
                    targetData: function () {
                        return target;
        ...
        $scope.printPopup = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvkeKhaiHangHoaXuatTuKhoDnSangTn', 'report'),
        ...
        $scope.update = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvkeKhaiHangHoaXuatTuKhoDnSangTn', 'update'),
                controller: 'keKhaiHangHoaXuatTuKhoDnSangTnEditController',
                windowClass: 'app-modal-window',
                //size:'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.print = function () {
            ...
            keKhaiHangHoaXuatTuKhoDnSangTnService.setParameterPrint(
                postdata);
            $state.go("nvPrintkeKhaiHangHoaXuatTuKhoDnSangTn");
        }
        $scope.printDetail = function () {
            var postdata = { paged: $scope.paged, filtered: $scope.filtered };
            keKhaiHangHoaXuatTuKhoDnSangTnService.setParameterPrint(
                postdata);
            $state.go("nvPrintDetailkeKhaiHangHoaXuatTuKhoDnSangTn");
        }
        ...
        $scope.deleteItem = function (ev, item) {
            ...
            $mdDialog.show(confirm).then(function () {
                keKhaiHangHoaXuatTuKhoDnSangTnService.deleteItem(item).then(function (data) {
                    console.log(data);
                }).then(function (data) {
                    $mdDialog.show(
                            $mdDialog.alert()
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnSangTnDetailsController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangHoaXuatTuKhoDnSangTnService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    ...
    $scope.tempData = mdService.tempData;
    $scope.title = function () {
        return 'Phiếu kê khai hàng hóa xuất từ kho doanh nghiệp sang loại hình tái nhập';
    };
    ...
    $scope.approval = function () {
        keKhaiHangHoaXuatTuKhoDnSangTnService.postApproval($scope.target, function (response) {
            if (response) {

                alert("Duyệt thành công!");
                $uibModalInstance.close($scope.target);
                $scope.goIndex = function () {
                    $state.go('nvkeKhaiHangHoaXuatTuKhoDnSangTn');
                };
    ...
    function fillterData() {
        $scope.isLoading = true;
        keKhaiHangHoaXuatTuKhoDnSangTnService.getDetails($scope.target.id, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnSangTnHistoryController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangHoaXuatTuKhoDnSangTnService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    mdService, keKhaiHangHoaXuatTuKhoDnSangTnService, targetData, clientService, configService, $filter) {
    ...
    function fillterData() {
        ...
        keKhaiHangHoaXuatTuKhoDnSangTnService.getHistories(choiceObj, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnSangTnCreateController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log', '$rootScope',
    'nvService', 'keKhaiHangHoaXuatTuKhoDnSangTnService', 'mdService', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log, $rootScope,
        nvService, keKhaiHangHoaXuatTuKhoDnSangTnService, mdService, configService, serviceNhapHangAndMerchandise, focus) {
        $scope.robot = angular.copy(keKhaiHangHoaXuatTuKhoDnSangTnService.robot);
        $scope.paged = angular.copy(configService.pageDefault);
        $scope.config = nvService.config;
        $scope.tempData = mdService.tempData;
        $scope.newItem = {};
        ...
        $scope.selectedMaHang = function (code) {
            if (code) {
                keKhaiHangHoaXuatTuKhoDnSangTnService.getMerchandiseForNvByCode(code).then(function (response) {
        ...
        $scope.save = function () {
            $scope.Loading = true;
            keKhaiHangHoaXuatTuKhoDnSangTnService.post(
        ...
        function filterData() {
            $scope.isLoading = true;
            keKhaiHangHoaXuatTuKhoDnSangTnService.getNewInstance(function (response) {
                ...
                //keKhaiHangHoaXuatTuKhoDnSangTnService.getCurrentUser(function (response) {
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnSangTnEditController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log',
    'nvService', 'keKhaiHangHoaXuatTuKhoDnSangTnService', 'mdService', 'targetData', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log,
        ...
        $scope.title = function () {
            return 'Phiếu kê khai hàng hóa từ kho doanh nghiệp sang loại hình tái nhập';
        };

        $scope.selectedkhachHang = function (item) {
            $scope.target.maKhachHang = item.value;
            keKhaiHangHoaXuatTuKhoDnSangTnService.getCustomer(item.id, function (response) {
                $scope.target.maSoThue = response.maSoThue;
            });
        };
        // $scope.selectedkhachHang = function (item) {
        // $scope.target.maKhachHang = item.value;
        // keKhaiHangHoaXuatTuKhoDnSangTnService.getOrderByCustomer(item.value, function (response) {
        ...
        $scope.save = function () {
            keKhaiHangHoaXuatTuKhoDnSangTnService.updateCT($scope.target).then(
                    function (response) {
            ...
            keKhaiHangHoaXuatTuKhoDnSangTnService.updateCT($scope.target).then(
                    function (response) {
                        if (response.data.status) {
                            ...
                            var url = $state.href('reportkeKhaiHangHoaXuatTuKhoDnSangTn', { id: response.data.data.id });
...
nvModule.controller('reportkeKhaiHangHoaXuatTuKhoDnSangTnController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state', '$uibModalInstance', 'targetData', '$rootScope',
    'mdService', 'keKhaiHangHoaXuatTuKhoDnSangTnService', 'clientService',
    function ($scope, $filter, $window, $stateParams, $timeout, $state, $uibModalInstance, targetData, $rootScope,
        ...
        function filterData() {
            if (targetData.id) {
                keKhaiHangHoaXuatTuKhoDnSangTnService.getReport(targetData.id, function (response) {
...
nvModule.controller('printkeKhaiHangHoaXuatTuKhoDnSangTnController', [
    ...
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        ...
        function filterData() {
            keKhaiHangHoaXuatTuKhoDnSangTnService.postPrint(
                function (response) {
                    $scope.printData = response;
                });
        };

        $scope.info = keKhaiHangHoaXuatTuKhoDnSangTnService.getParameterPrint().filtered.advanceData;
        $scope.goIndex = function () {
            $state.go("nvkeKhaiHangHoaXuatTuKhoDnSangTn");
        }
        $scope.printExcel = function () {
...
nvModule.controller('printDetailkeKhaiHangHoaXuatTuKhoDnSangTnController', [
    '$scope', '$state', '$window', '$stateParams', '$timeout', '$filter',
    'mdService', 'keKhaiHangHoaXuatTuKhoDnSangTnService', 'clientService',
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        mdService, keKhaiHangHoaXuatTuKhoDnSangTnService, clientService) {
        ...
        function filterData() {
            keKhaiHangHoaXuatTuKhoDnSangTnService.postPrintDetail(
                function (response) {
                    $scope.printData = response;
                });
        }
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnSangTnExportItemController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state',
    'mdService', 'keKhaiHangHoaXuatTuKhoDnSangTnService', 'clientService', '$uibModalInstance', 'targetData', 'Excel', 'configService', '$location',
    function ($scope, $filter, $window, $stateParams, $timeout, $state,
        ...
        keKhaiHangHoaXuatTuKhoDnSangTnService.getUnitName($scope.maDonVi).then(function (response) {
            $scope.tenDonVi = response.data;
        });
        keKhaiHangHoaXuatTuKhoDnSangTnService.getInfoItemDetails($scope.target.id, function (response) {
            console.log(response);
            if (response.status) {
        ...
        $scope.exportToExcel = function () {
            keKhaiHangHoaXuatTuKhoDnSangTnService.writeDataToExcel($scope.dataHangHoa, function (response) {
                if (response.status) {
                    clientService.noticeAlert("Thành công", "success");
                    //  $uibModalInstance.close($scope.target);
                }
