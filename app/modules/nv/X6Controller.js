var keKhaiHangHoaXuatTuKhoDnService = nvModule.factory('keKhaiHangHoaXuatTuKhoDnService',
[
    '$resource', '$http', '$window', 'configService', 'clientService',
    function ($resource, $http, $window, configService, clientService) {
        var rootUrl = configService.apiServiceBaseUri;
        var serviceUrl = rootUrl + '/api/Nv/KeKhaiHangXuatKhoDn/NvKeKhaiHangXuatTuKhoDn';
...
var keKhaiHangHoaXuatTuKhoDnController = nvModule.controller('keKhaiHangHoaXuatTuKhoDnController', [
    '$scope', '$rootScope', '$location', '$window', '$uibModal', '$log', '$state', '$filter', '$http',
    'keKhaiHangHoaXuatTuKhoDnService', 'configService', 'clientService', 'nvService', 'mdService', 'blockUI', 'serviceNhapHangAndMerchandise', '$mdDialog', 'localStorageService', 'authorizeService', 'serviceCompanySelected',
    function (
        $scope, $rootScope, $location, $window, $uibModal, $log, $state, $filter, $http,
        keKhaiHangHoaXuatTuKhoDnService, configService, clientService, nvService, mdService, blockUI, serviceNhapHangAndMerchandise, $mdDialog, localStorageService, authorizeService, serviceCompanySelected
    ) {
        ...
        $scope.selectedCompany = function (code) {
            if (code) {
                keKhaiHangHoaXuatTuKhoDnService.getSelectCompanyByCode(code).then(function (response) {
        ...
        $scope.title = function () {
            return 'Kê khai hàng hóa xuất từ kho doanh nghiệp lên cửa hàng';
        };
        ...
        $scope.create = function () {
            ...
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvkeKhaiHangHoaXuatTuKhoDn', 'add'),
                controller: 'keKhaiHangHoaXuatTuKhoDnCreateController',
        ...
        $scope.details = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangHoaXuatTuKhoDn', 'details'),
                controller: 'keKhaiHangHoaXuatTuKhoDnDetailsController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.histories = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangHoaXuatTuKhoDn', 'histories'),
                controller: 'keKhaiHangHoaXuatTuKhoDnHistoryController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.printITem = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvkeKhaiHangHoaXuatTuKhoDn', 'printItem'),
                controller: 'keKhaiHangHoaXuatTuKhoDnExportItemController',
                windowClass: 'app-modal-window',
                resolve: {
                    targetData: function () {
                        return target;
        ...
        $scope.printPopup = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvkeKhaiHangHoaXuatTuKhoDn', 'report'),
        ...
        $scope.update = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvkeKhaiHangHoaXuatTuKhoDn', 'update'),
                controller: 'keKhaiHangHoaXuatTuKhoDnEditController',
                windowClass: 'app-modal-window',
                //size:'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.print = function () {
            ...
            keKhaiHangHoaXuatTuKhoDnService.setParameterPrint(
                postdata);
            $state.go("nvPrintkeKhaiHangHoaXuatTuKhoDn");
        }
        $scope.printDetail = function () {
            ...
            keKhaiHangHoaXuatTuKhoDnService.setParameterPrint(
                postdata);
            $state.go("nvPrintDetailkeKhaiHangHoaXuatTuKhoDn");
        }
        ...
        $scope.deleteItem = function (ev, item) {
            ...
            $mdDialog.show(confirm).then(function () {
                keKhaiHangHoaXuatTuKhoDnService.deleteItem(item).then(function (data) {
                    console.log(data);
                }).then(function (data) {
                    $mdDialog.show(
                            $mdDialog.alert()
        ...
        $scope.import = function () {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'nvKeKhaiHangHoaXuatTuKhoDn', 'import'),
                controller: 'keKhaiHangHoaXuatTuKhoDnImportController',
                size: 'md'
            });
            modalInstance.result.then(function (updatedData) {
                serviceNhapHangAndMerchandise.getSelectData().clear();
        ...
        function filterData() {
            ...
            var postdata = { paged: $scope.paged, filtered: $scope.filtered };
            keKhaiHangHoaXuatTuKhoDnService.postQuery(
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnDetailsController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangHoaXuatTuKhoDnService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    ...
    $scope.approval = function () {
        keKhaiHangHoaXuatTuKhoDnService.postApproval($scope.target, function (response) {
            if (response) {
                alert("Duyệt thành công!");
                $uibModalInstance.close($scope.target);
                $scope.goIndex = function () {
                    $state.go('nvkeKhaiHangHoaXuatTuKhoDn');
                };
    ...
    function fillterData() {
        $scope.isLoading = true;
        keKhaiHangHoaXuatTuKhoDnService.getDetails($scope.target.id, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnHistoryController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangHoaXuatTuKhoDnService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    mdService, keKhaiHangHoaXuatTuKhoDnService, targetData, clientService, configService, $filter) {
    ...
    function fillterData() {
        ...
        keKhaiHangHoaXuatTuKhoDnService.getHistories(choiceObj, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnCreateController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log', '$rootScope',
    'nvService', 'keKhaiHangHoaXuatTuKhoDnService', 'mdService', 'configService', 'serviceNhapHangAndMerchandise', 'focus', '$resource',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log, $rootScope,
        nvService, keKhaiHangHoaXuatTuKhoDnService, mdService, configService, serviceNhapHangAndMerchandise, focus, $resource) {
        var rootUrl = configService.apiServiceBaseUri;

        $scope.robot = angular.copy(keKhaiHangHoaXuatTuKhoDnService.robot);
        $scope.paged = angular.copy(configService.pageDefault);
        $scope.config = nvService.config;
        $scope.tempData = mdService.tempData;
        $scope.newItem = {};
        ...
        $scope.title = function () {
            return 'Phiếu kê khai hàng hóa xuất kho doanh nghiệp lên cửa hàng';
        };


        $scope.selectedMaHang = function (code) {
            if (code) {
                keKhaiHangHoaXuatTuKhoDnService.getMerchandiseForNvByCode(code).then(function (response) {
        ...
        $scope.save = function () {
            $scope.Loading = true;
            keKhaiHangHoaXuatTuKhoDnService.post(
        ...
        function filterData() {
            $scope.isLoading = true;
            keKhaiHangHoaXuatTuKhoDnService.getNewInstance(function (response) {
                ...
                //keKhaiHangHoaXuatTuKhoDnService.getCurrentUser(function (response) {
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnEditController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log',
    'nvService', 'keKhaiHangHoaXuatTuKhoDnService', 'mdService', 'targetData', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log,
        ...
        $scope.title = function () {
            return 'Phiếu kê khai hàng hóa xuất từ kho doanh nghiệp lên cửa hàng';
        };
        $scope.selectedKhoXuat = function (item) {
            $scope.target.tenKhoXuat = item.description;
        }
        ...
        $scope.selectedkhachHang = function (item) {
            ...
            keKhaiHangHoaXuatTuKhoDnService.getCustomer(item.id, function (response) {
        ...
        $scope.save = function () {
            keKhaiHangHoaXuatTuKhoDnService.updateCT($scope.target).then(
                    function (response) {
            ...
            keKhaiHangHoaXuatTuKhoDnService.updateCT($scope.target).then(
                    function (response) {
                        if (response.data.status) {
                            ...
                            var url = $state.href('reportkeKhaiHangHoaXuatTuKhoDn', { id: response.data.data.id });
...
nvModule.controller('reportkeKhaiHangHoaXuatTuKhoDnController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state', 'targetData', '$uibModalInstance', '$rootScope',
    'mdService', 'keKhaiHangHoaXuatTuKhoDnService', 'clientService',
    function ($scope, $filter, $window, $stateParams, $timeout, $state, targetData, $uibModalInstance, $rootScope,
        ...
        function filterData() {
            if (targetData.id) {
                keKhaiHangHoaXuatTuKhoDnService.getReport(targetData.id, function (response) {
                    console.log(response);
                    if (response.status) {
                        $scope.target = response.data;
...
nvModule.controller('printkeKhaiHangHoaXuatTuKhoDnController', [
    ...
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        ...
        function filterData() {
            keKhaiHangHoaXuatTuKhoDnService.postPrint(
                function (response) {
                    $scope.printData = response;
                });
        };

        $scope.info = keKhaiHangHoaXuatTuKhoDnService.getParameterPrint().filtered.advanceData;
        $scope.goIndex = function () {
            $state.go("nvKeKhaiHangHoaXuatTuKhoDn");
        }
        $scope.printExcel = function () {
...
nvModule.controller('printDetailkeKhaiHangHoaXuatTuKhoDnController', [
    '$scope', '$state', '$window', '$stateParams', '$timeout', '$filter',
    'mdService', 'keKhaiHangHoaXuatTuKhoDnService', 'clientService',
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        mdService, keKhaiHangHoaXuatTuKhoDnService, clientService) {
        ...
        function filterData() {
            keKhaiHangHoaXuatTuKhoDnService.postPrintDetail(
                function (response) {
                    $scope.printData = response;
                });
        }
...
nvModule.controller('keKhaiHangHoaXuatTuKhoDnExportItemController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state',
    'mdService', 'keKhaiHangHoaXuatTuKhoDnService', 'clientService', '$uibModalInstance', 'targetData', 'Excel', 'configService', '$location',
    function ($scope, $filter, $window, $stateParams, $timeout, $state,
        ...
        keKhaiHangHoaXuatTuKhoDnService.getUnitName($scope.maDonVi).then(function (response) {
            $scope.tenDonVi = response.data;
        });
        keKhaiHangHoaXuatTuKhoDnService.getInfoItemDetails($scope.target.id, function (response) {
            console.log(response);
            if (response.status) {
        ...
        $scope.exportToExcel = function () {
            keKhaiHangHoaXuatTuKhoDnService.writeDataToExcel($scope.dataHangHoa, function (response) {
                if (response.status) {
                    clientService.noticeAlert("Thành công", "success");
                    //  $uibModalInstance.close($scope.target);
                }
