var xuatHangTuCuaHangVeKhoService = nvModule.factory('xuatHangTuCuaHangVeKhoService',
[
    '$resource', '$http', '$window', 'configService', 'clientService',
    function ($resource, $http, $window, configService, clientService) {
        var rootUrl = configService.apiServiceBaseUri;
        var serviceUrl = rootUrl + '/api/Nv/XuatHangTuCuaHangMienThue/XuatTraVeKho';
...
var xuatHangTuCuaHangVeKhoController = nvModule.controller('xuatHangTuCuaHangVeKhoController', [
    '$scope', '$rootScope', '$location', '$window', '$uibModal', '$log', '$state', '$filter', '$http',
    'xuatHangTuCuaHangVeKhoService', 'configService', 'clientService', 'nvService', 'mdService', 'blockUI', 'serviceNhapHangAndMerchandise', '$mdDialog', 'localStorageService', 'authorizeService', 'serviceCompanySelected',
    function (
        $scope, $rootScope, $location, $window, $uibModal, $log, $state, $filter, $http,
        xuatHangTuCuaHangVeKhoService, configService, clientService, nvService, mdService, blockUI, serviceNhapHangAndMerchandise, $mdDialog, localStorageService, authorizeService, serviceCompanySelected) {
        ...
        $scope.selectedCompany = function (code) {
            if (code) {
                xuatHangTuCuaHangVeKhoService.getSelectCompanyByCode(code).then(function (response) {
        ...
        $scope.create = function () {
            ...
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('XuatHangTuCuaHangMienThue', 'xuatHangTraVeKho', 'add'),
                controller: 'xuatHangTuCuaHangVeKhoCreateController',
        ...
        $scope.details = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('XuatHangTuCuaHangMienThue', 'xuatHangTraVeKho', 'details'),
                controller: 'xuatHangTuCuaHangVeKhoDetailsController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.histories = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('XuatHangTuCuaHangMienThue', 'xuatHangTraVeKho', 'histories'),
                controller: 'xuatHangTuCuaHangVeKhoHistoryController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.printPopup = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('XuatHangTuCuaHangMienThue', 'xuatHangTraVeKho', 'report'),
        ...
        $scope.update = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('XuatHangTuCuaHangMienThue', 'xuatHangTraVeKho', 'update'),
                controller: 'xuatHangTuCuaHangVeKhoEditController',
                windowClass: 'app-modal-window',
                //size:'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.print = function () {
            ...
            xuatHangTuCuaHangVeKhoService.setParameterPrint(
                postdata);
            $state.go("nvPrintxuatHangTuCuaHangVeKho");
        }
        $scope.printDetail = function () {
            ...
            xuatHangTuCuaHangVeKhoService.setParameterPrint(
                postdata);
            $state.go("nvPrintDetailxuatHangTuCuaHangVeKho");
        }
        ...
        $scope.deleteItem = function (ev, item) {
            ...
            $mdDialog.show(confirm).then(function () {
                xuatHangTuCuaHangVeKhoService.deleteItem(item).then(function (data) {
                    console.log(data);
                }).then(function (data) {
                    $mdDialog.show(
                            $mdDialog.alert()
        ...
        $scope.import = function () {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'nvxuatHangTuCuaHangVeKho', 'import'),
                controller: 'xuatHangTuCuaHangVeKhoImportController',
                size: 'md'
            });
            modalInstance.result.then(function (updatedData) {
                serviceNhapHangAndMerchandise.getSelectData().clear();
        ...
        function filterData() {
            ...
            var postdata = { paged: $scope.paged, filtered: $scope.filtered };
            xuatHangTuCuaHangVeKhoService.postQuery(
...
nvModule.controller('xuatHangTuCuaHangVeKhoDetailsController', [
'$scope', '$uibModalInstance',
'mdService', 'xuatHangTuCuaHangVeKhoService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    ...
    $scope.approval = function () {
        xuatHangTuCuaHangVeKhoService.postApproval($scope.target, function (response) {
            if (response) {

                alert("Duyệt thành công!");
                $uibModalInstance.close($scope.target);
                $scope.goIndex = function () {
                    $state.go('nvxuatHangTuCuaHangVeKho');
                };
    ...
    function fillterData() {
        ...
        xuatHangTuCuaHangVeKhoService.getDetails($scope.target.id, function (response) {
            if (response.status) {
            ...
            if (data && dataCustom && dataWarehouse && store) {
                $scope.target.tenDoanhNghiep = data[0].description;
...
nvModule.controller('xuatHangTuCuaHangVeKhoCreateController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log', '$rootScope',
    'nvService', 'xuatHangTuCuaHangVeKhoService', 'mdService', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log, $rootScope,
        nvService, xuatHangTuCuaHangVeKhoService, mdService, configService, serviceNhapHangAndMerchandise, focus) {
        $scope.robot = angular.copy(xuatHangTuCuaHangVeKhoService.robot);
        $scope.paged = angular.copy(configService.pageDefault);
        $scope.config = nvService.config;
        $scope.tempData = mdService.tempData;
        $scope.newItem = {};
                ...
                if (exsist) {
                    ...
                    angular.forEach($scope.target.dataDetails, function (v, k) {
                        if (v.maHang == $scope.newItem.maHang && $scope.newItem.soToKhai == v.soToKhai) {
                            ...
                            xuatHangTuCuaHangVeKhoService.robot.changeSoLuong($scope.target.dataDetails[k]);
                        }
                    });
                } else {
        ...
        $scope.selectedMaHang = function(code) {
            if (code) {
                xuatHangTuCuaHangVeKhoService.getMerchandiseForNvByCode(code).then(function(response) {
        ...
        $scope.save = function () {
            $scope.Loading = true;
            xuatHangTuCuaHangVeKhoService.post(
        ...
        function filterData() {
            $scope.isLoading = true;
            xuatHangTuCuaHangVeKhoService.getNewInstance(function (response) {
                ...
                //xuatHangTuCuaHangVeKhoService.getCurrentUser(function (response) {
...
nvModule.controller('xuatHangTuCuaHangVeKhoEditController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log',
    'nvService', 'xuatHangTuCuaHangVeKhoService', 'mdService', 'targetData', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log,
        ...
        $scope.save = function () {
            xuatHangTuCuaHangVeKhoService.updateCT($scope.target).then(
                    function (response) {
...
nvModule.controller('xuatHangTuCuaHangVeKhoHistoryController', [
'$scope', '$uibModalInstance',
'mdService', 'xuatHangTuCuaHangVeKhoService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    mdService, xuatHangTuCuaHangVeKhoService, targetData, clientService, configService, $filter) {
    ...
    function fillterData() {
        ...
        xuatHangTuCuaHangVeKhoService.getHistories(choiceObj, function (response) {
            if (response.status) {
...
nvModule.controller('reportXuatHangTuCuaHangVeKhoController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state', 'targetData', '$uibModalInstance',
    'mdService', 'xuatHangTuCuaHangVeKhoService', 'clientService',
    function ($scope, $filter, $window, $stateParams, $timeout, $state, targetData, $uibModalInstance,
        mdService, xuatHangTuCuaHangVeKhoService, clientService) {
        $scope.robot = angular.copy(xuatHangTuCuaHangVeKhoService.robot);
        ...
        function filterData() {
            if (targetData.id) {
                xuatHangTuCuaHangVeKhoService.getReport(targetData.id, function (response) {
                    console.log(response);
                    if (response.status) {
                        $scope.target = response.data;
                        // var data = 
...
nvModule.controller('printxuatHangTuCuaHangVeKhoController', [
    ...
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        ...
        function filterData() {
            xuatHangTuCuaHangVeKhoService.postPrint(
                function (response) {
                    $scope.printData = response;
                });
        };

        $scope.info = xuatHangTuCuaHangVeKhoService.getParameterPrint().filtered.advanceData;
        $scope.goIndex = function () {
            $state.go("nvXuatHangTraVeKho");
        }
        $scope.printExcel = function () {
...
nvModule.controller('printDetailxuatHangTuCuaHangVeKhoController', [
    '$scope', '$state', '$window', '$stateParams', '$timeout', '$filter',
    'mdService', 'xuatHangTuCuaHangVeKhoService', 'clientService',
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        mdService, xuatHangTuCuaHangVeKhoService, clientService) {
        ...
        function filterData() {
            xuatHangTuCuaHangVeKhoService.postPrintDetail(
                function (response) {
                    $scope.printData = response;
                });
        }
...
nvModule.controller('xuatHangTuCuaHangVeKhoExportItemController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state',
    'mdService', 'xuatHangTuCuaHangVeKhoService', 'clientService', '$uibModalInstance', 'targetData', 'Excel', 'configService', '$location',
    function ($scope, $filter, $window, $stateParams, $timeout, $state,
        ...
        xuatHangTuCuaHangVeKhoService.getUnitName($scope.maDonVi).then(function (response) {
            $scope.tenDonVi = response.data;
        });
        xuatHangTuCuaHangVeKhoService.getInfoItemDetails($scope.target.id, function (response) {
            console.log(response);
            if (response.status) {
        ...
        $scope.exportToExcel = function () {
            xuatHangTuCuaHangVeKhoService.writeDataToExcel($scope.dataHangHoa, function (response) {
                if (response.status) {
                    clientService.noticeAlert("Thành công", "success");
                    //  $uibModalInstance.close($scope.target);
                }
