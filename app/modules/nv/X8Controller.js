var keKhaiXuatHangMauHangThuTuKhoLenChService = nvModule.factory('keKhaiXuatHangMauHangThuTuKhoLenChService',
[
    '$resource', '$http', '$window', 'configService', 'clientService',
    function ($resource, $http, $window, configService, clientService) {
        var rootUrl = configService.apiServiceBaseUri;
        var serviceUrl = rootUrl + '/api/Nv/KeKhaiHangXuatKhoDn/KeKhaiXuatHangMauHangThuTuKhoLenCh';
...
var keKhaiXuatHangMauHangThuTuKhoLenChController = nvModule.controller('keKhaiXuatHangMauHangThuTuKhoLenChController', [
    '$scope', '$rootScope', '$location', '$window', '$uibModal', '$log', '$state', '$filter', '$http',
    'keKhaiXuatHangMauHangThuTuKhoLenChService', 'configService', 'clientService', 'nvService', 'mdService', 'blockUI', 'serviceNhapHangAndMerchandise', '$mdDialog', 'localStorageService', 'authorizeService', 'serviceCompanySelected',
    function (
        $scope, $rootScope, $location, $window, $uibModal, $log, $state, $filter, $http,
        keKhaiXuatHangMauHangThuTuKhoLenChService, configService, clientService, nvService, mdService, blockUI, serviceNhapHangAndMerchandise, $mdDialog, localStorageService, authorizeService, serviceCompanySelected
    ) {
        ...
        $scope.selectedCompany = function (code) {
            if (code) {
                keKhaiXuatHangMauHangThuTuKhoLenChService.getSelectCompanyByCode(code).then(function (response) {
        ...
        $scope.title = function () {
            return 'Kê khai hàng mẫu hàng thử xuất từ kho doanh nghiệp lên cửa hàng';
        };
        ...
        $scope.create = function () {
            ...
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangMauHangThuTuKhoLenCh', 'add'),
                controller: 'keKhaiXuatHangMauHangThuTuKhoLenChCreateController',
        ...
        $scope.details = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangMauHangThuTuKhoLenCh', 'details'),
                controller: 'keKhaiXuatHangMauHangThuTuKhoLenChDetailsController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.printPopup = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangMauHangThuTuKhoLenCh', 'report'),
        ...
        $scope.histories = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangMauHangThuTuKhoLenCh', 'histories'),
                controller: 'keKhaiXuatHangMauHangThuTuKhoLenChHistoryController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.printITem = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangMauHangThuTuKhoLenCh', 'printItem'),
                controller: 'keKhaiXuatHangMauHangThuTuKhoLenChExportItemController',
                windowClass: 'app-modal-window',
                resolve: {
                    targetData: function () {
                        return target;
        ...
        $scope.update = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangMauHangThuTuKhoLenCh', 'update'),
                controller: 'keKhaiXuatHangMauHangThuTuKhoLenChEditController',
                windowClass: 'app-modal-window',
                //size:'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.print = function () {
            ...
            keKhaiXuatHangMauHangThuTuKhoLenChService.setParameterPrint(
                postdata);
            $state.go("nvPrintkeKhaiXuatHangMauHangThuTuKhoLenCh");
        }
        $scope.printDetail = function () {
            ...
            keKhaiXuatHangMauHangThuTuKhoLenChService.setParameterPrint(
                postdata);
            $state.go("nvPrintDetailkeKhaiXuatHangMauHangThuTuKhoLenCh");
        }
        ...
        $scope.deleteItem = function (ev, item) {
            ...
            $mdDialog.show(confirm).then(function () {
                keKhaiXuatHangMauHangThuTuKhoLenChService.deleteItem(item).then(function (data) {
                    console.log(data);
                }).then(function (data) {
                    $mdDialog.show(
                            $mdDialog.alert()
        ...
        $scope.import = function () {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvKeKhaiHangMauHangThuTuKhoLenCh', 'import'),
                controller: 'keKhaiXuatHangMauHangThuTuKhoLenChImportController',
                size: 'md'
            });
            modalInstance.result.then(function (updatedData) {
                serviceNhapHangAndMerchandise.getSelectData().clear();
        ...
        function filterData() {
            ...
            var postdata = { paged: $scope.paged, filtered: $scope.filtered };
            keKhaiXuatHangMauHangThuTuKhoLenChService.postQuery(
...
nvModule.controller('keKhaiXuatHangMauHangThuTuKhoLenChDetailsController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiXuatHangMauHangThuTuKhoLenChService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    ...
    $scope.tempData = mdService.tempData;
    $scope.title = function () {
        return 'Phiếu kê khai hàng mẫu hàng thử xuất từ kho doanh nghiệp lên cửa hàng';
    };
    ...
    $scope.approval = function () {
        keKhaiXuatHangMauHangThuTuKhoLenChService.postApproval($scope.target, function (response) {
            if (response) {
                alert("Duyệt thành công!");
                $uibModalInstance.close($scope.target);
                $scope.goIndex = function () {
                    $state.go('nvKeKhaiXuatHangMauHangThuTuKhoLenCh');
                };
    ...
    function fillterData() {
        $scope.isLoading = true;
        keKhaiXuatHangMauHangThuTuKhoLenChService.getDetails($scope.target.id, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiXuatHangMauHangThuTuKhoLenChHistoryController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiXuatHangMauHangThuTuKhoLenChService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    mdService, keKhaiXuatHangMauHangThuTuKhoLenChService, targetData, clientService, configService, $filter) {
    ...
    function fillterData() {
        ...
        keKhaiXuatHangMauHangThuTuKhoLenChService.getHistories(choiceObj, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiXuatHangMauHangThuTuKhoLenChCreateController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log', '$rootScope',
    'nvService', 'keKhaiXuatHangMauHangThuTuKhoLenChService', 'mdService', 'configService', 'serviceNhapHangAndMerchandise', 'focus', '$resource',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log, $rootScope,
        nvService, keKhaiXuatHangMauHangThuTuKhoLenChService, mdService, configService, serviceNhapHangAndMerchandise, focus, $resource) {
        var rootUrl = configService.apiServiceBaseUri;

        $scope.robot = angular.copy(keKhaiXuatHangMauHangThuTuKhoLenChService.robot);
        $scope.paged = angular.copy(configService.pageDefault);
        $scope.config = nvService.config;
        $scope.tempData = mdService.tempData;
        $scope.newItem = {};
        ...
        $scope.selectedMaHang = function (code) {
            if (code) {
                keKhaiXuatHangMauHangThuTuKhoLenChService.getMerchandiseForNvByCode(code).then(function (response) {
        ...
        $scope.save = function () {
            $scope.Loading = true;
            keKhaiXuatHangMauHangThuTuKhoLenChService.post(
        ...
        function filterData() {
            $scope.isLoading = true;
            keKhaiXuatHangMauHangThuTuKhoLenChService.getNewInstance(function (response) {
                ...
                //keKhaiXuatHangMauHangThuTuKhoLenChService.getCurrentUser(function (response) {
...
nvModule.controller('keKhaiXuatHangMauHangThuTuKhoLenChEditController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log',
    'nvService', 'keKhaiXuatHangMauHangThuTuKhoLenChService', 'mdService', 'targetData', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log,
        ...
        $scope.selectedkhachHang = function (item) {
            ...
            keKhaiXuatHangMauHangThuTuKhoLenChService.getCustomer(item.id, function (response) {
        ...
        $scope.save = function () {
            keKhaiXuatHangMauHangThuTuKhoLenChService.updateCT($scope.target).then(
                    function (response) {
            ...
            keKhaiXuatHangMauHangThuTuKhoLenChService.updateCT($scope.target).then(
                    function (response) {
                        if (response.data.status) {
                            ...
                            var url = $state.href('reportkeKhaiXuatHangMauHangThuTuKhoLenCh', { id: response.data.data.id });
...
nvModule.controller('reportKeKhaiXuatHangMauHangThuTuKhoLenChController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state', 'targetData', '$uibModalInstance', '$rootScope',
    'mdService', 'keKhaiXuatHangMauHangThuTuKhoLenChService', 'clientService',
    function ($scope, $filter, $window, $stateParams, $timeout, $state, targetData, $uibModalInstance, $rootScope,
        ...
        function filterData() {
            if (targetData.id) {
                keKhaiXuatHangMauHangThuTuKhoLenChService.getReport(targetData.id, function (response) {
                    console.log(response);
                    if (response.status) {
                        $scope.target = response.data;
...
nvModule.controller('printkeKhaiXuatHangMauHangThuTuKhoLenChController', [
    ...
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        ...
        function filterData() {
            keKhaiXuatHangMauHangThuTuKhoLenChService.postPrint(
                function (response) {
                    $scope.printData = response;
                });
        };

        $scope.info = keKhaiXuatHangMauHangThuTuKhoLenChService.getParameterPrint().filtered.advanceData;
        $scope.goIndex = function () {
            $state.go("nvKeKhaiXuatHangMauHangThuTuKhoLenCh");
        }
        $scope.printExcel = function () {
...
nvModule.controller('printDetailkeKhaiXuatHangMauHangThuTuKhoLenChController', [
    '$scope', '$state', '$window', '$stateParams', '$timeout', '$filter',
    'mdService', 'keKhaiXuatHangMauHangThuTuKhoLenChService', 'clientService',
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        mdService, keKhaiXuatHangMauHangThuTuKhoLenChService, clientService) {
        ...
        function filterData() {
            keKhaiXuatHangMauHangThuTuKhoLenChService.postPrintDetail(
                function (response) {
                    $scope.printData = response;
                });
        }
...
nvModule.controller('keKhaiXuatHangMauHangThuTuKhoLenChExportItemController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state',
    'mdService', 'keKhaiXuatHangMauHangThuTuKhoLenChService', 'clientService', '$uibModalInstance', 'targetData', 'Excel', 'configService', '$location',
    function ($scope, $filter, $window, $stateParams, $timeout, $state,
        ...
        keKhaiXuatHangMauHangThuTuKhoLenChService.getUnitName($scope.maDonVi).then(function (response) {
            $scope.tenDonVi = response.data;
        });
        keKhaiXuatHangMauHangThuTuKhoLenChService.getInfoItemDetails($scope.target.id, function (response) {
            console.log(response);
            if (response.status) {
        ...
        $scope.exportToExcel = function () {
            keKhaiXuatHangMauHangThuTuKhoLenChService.writeDataToExcel($scope.dataHangHoa, function (response) {
                if (response.status) {
                    clientService.noticeAlert("Thành công", "success");
                    //  $uibModalInstance.close($scope.target);
                }
