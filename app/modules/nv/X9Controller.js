var xuatHangThuTuCuaHangVeKhoService = nvModule.factory('xuatHangThuTuCuaHangVeKhoService',
[
    '$resource', '$http', '$window', 'configService', 'clientService',
    function ($resource, $http, $window, configService, clientService) {
        var rootUrl = configService.apiServiceBaseUri;
        var serviceUrl = rootUrl + '/api/Nv/XuatHangTuCuaHangMienThue/XuatHangThuTraVeKho';
...
var xuatHangThuTuCuaHangVeKhoController = nvModule.controller('xuatHangThuTuCuaHangVeKhoController', [
    '$scope', '$rootScope', '$location', '$window', '$uibModal', '$log', '$state', '$filter', '$http',
    'xuatHangThuTuCuaHangVeKhoService', 'configService', 'clientService', 'nvService', 'mdService', 'blockUI', 'serviceNhapHangAndMerchandise', '$mdDialog', 'localStorageService', 'authorizeService', 'serviceCompanySelected',
    function (
        $scope, $rootScope, $location, $window, $uibModal, $log, $state, $filter, $http,
        xuatHangThuTuCuaHangVeKhoService, configService, clientService, nvService, mdService, blockUI, serviceNhapHangAndMerchandise, $mdDialog, localStorageService, authorizeService, serviceCompanySelected) {
        ...
        $scope.selectedCompany = function (code) {
            if (code) {
                xuatHangThuTuCuaHangVeKhoService.getSelectCompanyByCode(code).then(function (response) {
        ...
        $scope.title = function () {
            return 'Kê khai hàng mẫu, hàng thử xuất từ cửa hàng về kho';
        };
        ...
        $scope.printPopup = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('XuatHangTuCuaHangMienThue', 'xuatHangThuVeKho', 'report'),
        ...
        $scope.create = function () {
            ...
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('XuatHangTuCuaHangMienThue', 'xuatHangThuVeKho', 'add'),
                controller: 'xuatHangThuTuCuaHangVeKhoCreateController',
        ...
        $scope.details = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('XuatHangTuCuaHangMienThue', 'xuatHangThuVeKho', 'details'),
                controller: 'xuatHangThuTuCuaHangVeKhoDetailsController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.histories = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('XuatHangTuCuaHangMienThue', 'xuatHangThuVeKho', 'histories'),
                controller: 'xuatHangThuTuCuaHangVeKhoHistoryController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.update = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('XuatHangTuCuaHangMienThue', 'xuatHangThuVeKho', 'update'),
                controller: 'xuatHangThuTuCuaHangVeKhoEditController',
                windowClass: 'app-modal-window',
                //size:'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.print = function () {
            ...
            xuatHangThuTuCuaHangVeKhoService.setParameterPrint(
                postdata);
            $state.go("nvPrintxuatHangThuTuCuaHangVeKho");
        }
        $scope.printDetail = function () {
            ...
            xuatHangThuTuCuaHangVeKhoService.setParameterPrint(
                postdata);
            $state.go("nvPrintDetailxuatHangThuTuCuaHangVeKho");
        }
        ...
        $scope.deleteItem = function (ev, item) {
            ...
            $mdDialog.show(confirm).then(function () {
                xuatHangThuTuCuaHangVeKhoService.deleteItem(item).then(function (data) {
                    console.log(data);
                }).then(function (data) {
                    $mdDialog.show(
                            $mdDialog.alert()
        ...
        $scope.import = function () {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'nvxuatHangThuTuCuaHangVeKho', 'import'),
                controller: 'xuatHangThuTuCuaHangVeKhoImportController',
                size: 'md'
            });
            modalInstance.result.then(function (updatedData) {
                serviceNhapHangAndMerchandise.getSelectData().clear();
        ...
        function filterData() {
            ...
            var postdata = { paged: $scope.paged, filtered: $scope.filtered };
            xuatHangThuTuCuaHangVeKhoService.postQuery(
...
nvModule.controller('xuatHangThuTuCuaHangVeKhoDetailsController', [
'$scope', '$uibModalInstance',
'mdService', 'xuatHangThuTuCuaHangVeKhoService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    ...
    $scope.approval = function () {
        xuatHangThuTuCuaHangVeKhoService.postApproval($scope.target, function (response) {
            if (response) {

                alert("Duyệt thành công!");
                $uibModalInstance.close($scope.target);
                $scope.goIndex = function () {
                    $state.go('nvxuatHangThuTuCuaHangVeKho');
                };
    ...
    function fillterData() {
        ...
        xuatHangThuTuCuaHangVeKhoService.getDetails($scope.target.id, function (response) {
            if (response.status) {
...
nvModule.controller('xuatHangThuTuCuaHangVeKhoCreateController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log', '$rootScope',
    'nvService', 'xuatHangThuTuCuaHangVeKhoService', 'mdService', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log, $rootScope,
        nvService, xuatHangThuTuCuaHangVeKhoService, mdService, configService, serviceNhapHangAndMerchandise, focus) {
        $scope.robot = angular.copy(xuatHangThuTuCuaHangVeKhoService.robot);
        $scope.paged = angular.copy(configService.pageDefault);
        $scope.config = nvService.config;
        $scope.tempData = mdService.tempData;
        $scope.newItem = {};
                ...
                if (exsist) {
                    ...
                    angular.forEach($scope.target.dataDetails, function (v, k) {
                        if (v.maHang == $scope.newItem.maHang && $scope.newItem.soToKhai == v.soToKhai) {
                            ...
                            xuatHangThuTuCuaHangVeKhoService.robot.changeSoLuong($scope.target.dataDetails[k]);
                        }
                    });
                } else {
        ...
        $scope.selectedMaHang = function (code) {
            if (code) {
                xuatHangThuTuCuaHangVeKhoService.getMerchandiseForNvByCode(code).then(function (response) {
        ...
        $scope.save = function () {
            $scope.Loading = true;
            xuatHangThuTuCuaHangVeKhoService.post(
        ...
        function filterData() {
            $scope.isLoading = true;
            xuatHangThuTuCuaHangVeKhoService.getNewInstance(function (response) {
                ...
                //xuatHangThuTuCuaHangVeKhoService.getCurrentUser(function (response) {
...
nvModule.controller('xuatHangThuTuCuaHangVeKhoEditController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log',
    'nvService', 'xuatHangThuTuCuaHangVeKhoService', 'mdService', 'targetData', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log,
        ...
        $scope.save = function () {
            xuatHangThuTuCuaHangVeKhoService.updateCT($scope.target).then(
                    function (response) {
            ...
            xuatHangThuTuCuaHangVeKhoService.updateCT($scope.target).then(
                    function (response) {
                        if (response.data.status) {
                            ...
                            var url = $state.href('reportxuatHangThuTuCuaHangVeKho', { id: response.data.data.id });
...
nvModule.controller('xuatHangThuTuCuaHangVeKhoHistoryController', [
'$scope', '$uibModalInstance',
'mdService', 'xuatHangThuTuCuaHangVeKhoService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    mdService, xuatHangThuTuCuaHangVeKhoService, targetData, clientService, configService, $filter) {
    ...
    $scope.tempData = mdService.tempData;
    $scope.title = function () {
        return 'Kê khai hàng hóa xuất từ cửa hàng miễn thuế về kho';
    };
    ...
    function fillterData() {
        ...
        xuatHangThuTuCuaHangVeKhoService.getHistories(choiceObj, function (response) {
            if (response.status) {
...
nvModule.controller('reportXuatHangThuTuCuaHangVeKhoController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state', 'targetData', '$uibModalInstance', '$rootScope',
    'mdService', 'xuatHangThuTuCuaHangVeKhoService', 'clientService',
    function ($scope, $filter, $window, $stateParams, $timeout, $state, targetData, $uibModalInstance, $rootScope,
        ...
        function filterData() {
            if (targetData.id) {
                xuatHangThuTuCuaHangVeKhoService.getReport(targetData.id, function (response) {
                    console.log(response);
                    if (response.status) {
                        $scope.target = response.data;
...
nvModule.controller('printxuatHangThuTuCuaHangVeKhoController', [
    ...
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        ...
        function filterData() {
            xuatHangThuTuCuaHangVeKhoService.postPrint(
                function (response) {
                    $scope.printData = response;
                });
        };

        $scope.info = xuatHangThuTuCuaHangVeKhoService.getParameterPrint().filtered.advanceData;
        $scope.goIndex = function () {
            $state.go("nvxuatHangThuVeKho");
        }
        $scope.printExcel = function () {
...
nvModule.controller('printDetailxuatHangThuTuCuaHangVeKhoController', [
    '$scope', '$state', '$window', '$stateParams', '$timeout', '$filter',
    'mdService', 'xuatHangThuTuCuaHangVeKhoService', 'clientService',
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        mdService, xuatHangThuTuCuaHangVeKhoService, clientService) {
        ...
        function filterData() {
            xuatHangThuTuCuaHangVeKhoService.postPrintDetail(
                function (response) {
                    $scope.printData = response;
                });
        }
...
nvModule.controller('xuatHangThuTuCuaHangVeKhoExportItemController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state',
    'mdService', 'xuatHangThuTuCuaHangVeKhoService', 'clientService', '$uibModalInstance', 'targetData', 'Excel', 'configService', '$location',
    function ($scope, $filter, $window, $stateParams, $timeout, $state,
        ...
        xuatHangThuTuCuaHangVeKhoService.getUnitName($scope.maDonVi).then(function (response) {
            $scope.tenDonVi = response.data;
        });
        xuatHangThuTuCuaHangVeKhoService.getInfoItemDetails($scope.target.id, function (response) {
            console.log(response);
            if (response.status) {
        ...
        $scope.exportToExcel = function () {
            xuatHangThuTuCuaHangVeKhoService.writeDataToExcel($scope.dataHangHoa, function (response) {
                if (response.status) {
                    clientService.noticeAlert("Thành công", "success");
                    //  $uibModalInstance.close($scope.target);
                }
