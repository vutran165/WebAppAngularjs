var keKhaiHangHoaNhapKhoDnSangTnService = nvModule.factory('keKhaiHangHoaNhapKhoDnSangTnService',
[
    '$resource', '$http', '$window', 'configService', 'clientService',
    function ($resource, $http, $window, configService, clientService) {
        var rootUrl = configService.apiServiceBaseUri;
        var serviceUrl = rootUrl + '/api/Nv/KeKhaiHangNhapKhoDn/KeKhaiHangNhapKhoDnSangTn';
...
var keKhaiHangHoaNhapKhoDnSangTnController = nvModule.controller('keKhaiHangHoaNhapKhoDnSangTnController', [
    '$scope', '$rootScope', '$location', '$window', '$uibModal', '$log', '$state', '$filter', '$http',
    'keKhaiHangHoaNhapKhoDnSangTnService', 'configService', 'clientService', 'nvService', 'mdService', 'blockUI', 'serviceNhapHangAndMerchandise', '$mdDialog', 'localStorageService', 'authorizeService', 'serviceCompanySelected',
    function (
        $scope, $rootScope, $location, $window, $uibModal, $log, $state, $filter, $http,
        keKhaiHangHoaNhapKhoDnSangTnService, configService, clientService, nvService, mdService, blockUI, serviceNhapHangAndMerchandise, $mdDialog, localStorageService, authorizeService, serviceCompanySelected
    ) {
        ...
        $scope.selectedCompany = function (code) {
            if (code) {
                keKhaiHangHoaNhapKhoDnSangTnService.getSelectCompanyByCode(code).then(function (response) {
        ...
        function filterData() {
            ...
            keKhaiHangHoaNhapKhoDnSangTnService.postQuery(
        ...
        $scope.title = function () {
            return 'Kê khai hàng hóa nhập kho doanh nghiệp từ nguồn hàng tạm nhập';
        };
        ...
        $scope.create = function () {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'nvkeKhaiHangHoaNhapKhoDnSangTn', 'add'),
                controller: 'keKhaiHangHoaNhapKhoDnSangTnCreateController',
        ...
        $scope.details = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'nvkeKhaiHangHoaNhapKhoDnSangTn', 'details'),
                controller: 'keKhaiHangHoaNhapKhoDnSangTnDetailsController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.printPopup = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'nvkeKhaiHangHoaNhapKhoDnSangTn', 'report'),
        ...
        $scope.histories = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'nvkeKhaiHangHoaNhapKhoDnSangTn', 'histories'),
                controller: 'keKhaiHangHoaNhapKhoDnSangTnHistoryController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.printITem = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'nvkeKhaiHangHoaNhapKhoDnSangTn', 'printItem'),
                controller: 'keKhaiHangHoaNhapKhoDnSangTnExportItemController',
                windowClass: 'app-modal-window',
                resolve: {
                    targetData: function () {
                        return target;
        ...
        $scope.update = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'nvkeKhaiHangHoaNhapKhoDnSangTn', 'update'),
                controller: 'keKhaiHangHoaNhapKhoDnSangTnEditController',
                windowClass: 'app-modal-window',
                //size:'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.print = function () {
            ...
            keKhaiHangHoaNhapKhoDnSangTnService.setParameterPrint(
                postdata);
            $state.go("nvPrintkeKhaiHangHoaNhapKhoDnSangTn");
        }
        ...
        $scope.printDetail = function () {
            ...
            keKhaiHangHoaNhapKhoDnSangTnService.setParameterPrint(
                postdata);
            $state.go("nvPrintDetailkeKhaiHangHoaNhapKhoDnSangTn");
        }
        ...
        $scope.deleteItem = function (ev, item) {
            ...
            $mdDialog.show(confirm).then(function () {
                keKhaiHangHoaNhapKhoDnSangTnService.deleteItem(item).then(function (data) {
                    console.log(data);
                }).then(function (data) {
                    $mdDialog.show(
                            $mdDialog.alert()
...
nvModule.controller('keKhaiHangHoaNhapKhoDnSangTnDetailsController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangHoaNhapKhoDnSangTnService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    ...
    $scope.approval = function () {
        keKhaiHangHoaNhapKhoDnSangTnService.postApproval($scope.target, function (response) {
            if (response) {

                alert("Duyệt thành công!");
                $uibModalInstance.close($scope.target);
                $scope.goIndex = function () {
                    $state.go('nvkeKhaiHangHoaNhapKhoDnSangTn');
                };
    ...
    function fillterData() {
        $scope.isLoading = true;
        keKhaiHangHoaNhapKhoDnSangTnService.getDetails($scope.target.id, function (response) {
...
nvModule.controller('keKhaiHangHoaNhapKhoDnSangTnHistoryController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangHoaNhapKhoDnSangTnService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    mdService, keKhaiHangHoaNhapKhoDnSangTnService, targetData, clientService, configService, $filter) {
    ...
    function fillterData() {
        ...
        keKhaiHangHoaNhapKhoDnSangTnService.getHistories(choiceObj, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiHangHoaNhapKhoDnSangTnCreateController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log', '$rootScope',
    'nvService', 'keKhaiHangHoaNhapKhoDnSangTnService', 'mdService', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log, $rootScope,
        nvService, keKhaiHangHoaNhapKhoDnSangTnService, mdService, configService, serviceNhapHangAndMerchandise, focus) {
        $scope.robot = angular.copy(keKhaiHangHoaNhapKhoDnSangTnService.robot);
        $scope.paged = angular.copy(configService.pageDefault);
        $scope.config = nvService.config;
        $scope.tempData = mdService.tempData;
        $scope.newItem = {};
                ...
                if (exsist) {
                    ...
                    angular.forEach($scope.target.dataDetails, function (v, k) {
                        if (v.maHang == $scope.newItem.maHang && $scope.newItem.soToKhai == v.soToKhai) {
                            ...
                            keKhaiHangHoaNhapKhoDnTrongNuocService.robot.changeSoLuong($scope.target.dataDetails[k]);
                        }
                    });
                } else {
        ...
        $scope.selectedMaHang = function (code) {
            if (code) {
                keKhaiHangHoaNhapKhoDnSangTnService.getMerchandiseForNvByCode(code).then(function (response) {
        ...
        $scope.save = function () {
            $scope.Loading = true;
            keKhaiHangHoaNhapKhoDnSangTnService.post(
        ...
        function filterData() {
            $scope.isLoading = true;
            keKhaiHangHoaNhapKhoDnSangTnService.getNewInstance(function (response) {
...
nvModule.controller('keKhaiHangHoaNhapKhoDnSangTnEditController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log',
    'nvService', 'keKhaiHangHoaNhapKhoDnSangTnService', 'mdService', 'targetData', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log,
        ...
        $scope.save = function () {
            keKhaiHangHoaNhapKhoDnSangTnService.updateCT($scope.target).then(
                    function (response) {
            ...
            keKhaiHangHoaNhapKhoDnSangTnService.updateCT($scope.target).then(
                    function (response) {
                        if (response.data.status) {
                            ...
                            var url = $state.href('reportkeKhaiHangHoaNhapKhoDnSangTn', { id: response.data.data.id });
...
nvModule.controller('reportKeKhaiHangHoaNhapKhoDnSangTnController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state', 'targetData', '$rootScope', '$uibModalInstance',
    'mdService', 'keKhaiHangHoaNhapKhoDnSangTnService', 'clientService',
    function ($scope, $filter, $window, $stateParams, $timeout, $state, targetData, $rootScope, $uibModalInstance,
        mdService, keKhaiHangHoaNhapKhoDnSangTnService, clientService) {
        $scope.robot = angular.copy(keKhaiHangHoaNhapKhoDnSangTnService.robot);
        ...
        function filterData() {
            if (targetData.id) {
                keKhaiHangHoaNhapKhoDnSangTnService.getReport(targetData.id, function (response) {
        ...
        $scope.printExcel = function () {
            ...
            var fileName = "KeKhaiHangTuKhoDoanhNghiepSangLoaiHinhTaiXuat_ExportData.xls";
...
nvModule.controller('printkeKhaiHangHoaNhapKhoDnSangTnController', [
    ...
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        ...
        function filterData() {
            keKhaiHangHoaNhapKhoDnSangTnService.postPrint(
                function (response) {
                    $scope.printData = response;
                });
        };

        $scope.info = keKhaiHangHoaNhapKhoDnSangTnService.getParameterPrint().filtered.advanceData;
        $scope.goIndex = function () {
            $state.go('nvkeKhaiHangHoaNhapKhoDnSangTn');
        }
        $scope.printExcel = function () {
...
nvModule.controller('printDetailkeKhaiHangHoaNhapKhoDnSangTnController', [
    '$scope', '$state', '$window', '$stateParams', '$timeout', '$filter',
    'mdService', 'keKhaiHangHoaNhapKhoDnSangTnService', 'clientService',
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        mdService, keKhaiHangHoaNhapKhoDnSangTnService, clientService) {
        ...
        function filterData() {
            keKhaiHangHoaNhapKhoDnSangTnService.postPrintDetail(
                function (response) {
                    $scope.printData = response;
                });
        }
...
nvModule.controller('keKhaiHangHoaNhapKhoDnSangTnExportItemController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state',
    'mdService', 'keKhaiHangHoaNhapKhoDnSangTnService', 'clientService', '$uibModalInstance', 'targetData', 'Excel', 'configService', '$location',
    function ($scope, $filter, $window, $stateParams, $timeout, $state,
        ...
        keKhaiHangHoaNhapKhoDnSangTnService.getUnitName($scope.maDonVi).then(function (response) {
            $scope.tenDonVi = response.data;
        });

        keKhaiHangHoaNhapKhoDnSangTnService.getInfoItemDetails($scope.target.id, function (response) {
            console.log(response);
            if (response.status) {
        ...
        $scope.exportToExcel = function () {
            keKhaiHangHoaNhapKhoDnSangTnService.writeDataToExcel($scope.dataHangHoa, function (response) {
                if (response.status) {
                    clientService.noticeAlert("Thành công", "success");
                    //  $uibModalInstance.close($scope.target);
                }
