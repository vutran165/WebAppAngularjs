var keKhaiHangHoaNhapKhoDnTrongNuocService = nvModule.factory('keKhaiHangHoaNhapKhoDnTrongNuocService',
[
    '$resource', '$http', '$window', 'configService', 'clientService',
    function ($resource, $http, $window, configService, clientService) {
        var rootUrl = configService.apiServiceBaseUri;
        var serviceUrl = rootUrl + '/api/Nv/KeKhaiHangNhapKhoDn/KeKhaiHangNhapKhoDnTrongNuoc';
...
var keKhaiHangHoaNhapKhoDnTrongNuocController = nvModule.controller('keKhaiHangHoaNhapKhoDnTrongNuocController', [
    '$scope', '$rootScope', '$location', '$window', '$uibModal', '$log', '$state', '$filter', '$http',
    'keKhaiHangHoaNhapKhoDnTrongNuocService', 'configService', 'clientService', 'nvService', 'mdService', 'blockUI', 'serviceNhapHangAndMerchandise', '$mdDialog', 'localStorageService', 'authorizeService','serviceCompanySelected',
    function (
        $scope, $rootScope, $location, $window, $uibModal, $log, $state, $filter, $http,
        keKhaiHangHoaNhapKhoDnTrongNuocService, configService, clientService, nvService, mdService, blockUI, serviceNhapHangAndMerchandise, $mdDialog, localStorageService, authorizeService, serviceCompanySelected
    ) {
        ...
        $scope.selectedCompany = function (code) {
            if (code) {
                keKhaiHangHoaNhapKhoDnTrongNuocService.getSelectCompanyByCode(code).then(function (response) {
        ...
        function filterData() {
            ...
            keKhaiHangHoaNhapKhoDnTrongNuocService.postQuery(
        ...
        $scope.title = function () {
            return 'Kê khai hàng hóa nhập kho doanh nghiệp từ nguồn hàng sản xuất trong nước';
        };
        ...
        $scope.create = function () {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'nvkeKhaiHangHoaNhapKhoDnTrongNuoc', 'add'),
                controller: 'keKhaiHangHoaNhapKhoDnTrongNuocCreateController',
        ...
        $scope.details = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'nvkeKhaiHangHoaNhapKhoDnTrongNuoc', 'details'),
                controller: 'keKhaiHangHoaNhapKhoDnTrongNuocDetailsController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.histories = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'nvkeKhaiHangHoaNhapKhoDnTrongNuoc', 'histories'),
                controller: 'keKhaiHangHoaNhapKhoDnTrongNuocHistoryController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.printPopup = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'nvkeKhaiHangHoaNhapKhoDnTrongNuoc', 'report'),
        ...
        $scope.printITem = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'nvkeKhaiHangHoaNhapKhoDnTrongNuoc', 'printItem'),
                controller: 'keKhaiHangHoaNhapKhoDnTrongNuocExportItemController',
                windowClass: 'app-modal-window',
                resolve: {
                    targetData: function () {
                        return target;
        ...
        $scope.update = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'nvkeKhaiHangHoaNhapKhoDnTrongNuoc', 'update'),
                controller: 'keKhaiHangHoaNhapKhoDnTrongNuocEditController',
                windowClass: 'app-modal-window',
                //size:'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.print = function () {
            ...
            keKhaiHangHoaNhapKhoDnTrongNuocService.setParameterPrint(
                postdata);
            $state.go("nvPrintkeKhaiHangHoaNhapKhoDnTrongNuoc");
        }
        $scope.printDetail = function () {
            ...
            keKhaiHangHoaNhapKhoDnTrongNuocService.setParameterPrint(
                postdata);
            $state.go("nvPrintDetailkeKhaiHangHoaNhapKhoDnTrongNuoc");
        }
        ...
        $scope.deleteItem = function (ev, item) {
            ...
            $mdDialog.show(confirm).then(function () {
                keKhaiHangHoaNhapKhoDnTrongNuocService.deleteItem(item).then(function (data) {
                    console.log(data);
                }).then(function (data) {
                    $mdDialog.show(
                            $mdDialog.alert()
...
nvModule.controller('keKhaiHangHoaNhapKhoDnTrongNuocDetailsController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangHoaNhapKhoDnTrongNuocService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    ...
    function fillterData() {
        $scope.isLoading = true;
        keKhaiHangHoaNhapKhoDnTrongNuocService.getDetails($scope.target.id, function (response) {
            console.log(response);
            if (response.status) {
...
nvModule.controller('keKhaiHangHoaNhapKhoDnTrongNuocHistoryController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangHoaNhapKhoDnTrongNuocService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    mdService, keKhaiHangHoaNhapKhoDnTrongNuocService, targetData, clientService, configService, $filter) {
    ...
    $scope.tempData = mdService.tempData;
    $scope.title = function () {
        return 'Phiếu kê khai hàng hóa nhập kho doanh nghiệp từ nguồn hàng sản xuất trong nước ';
    };
    ...
    function fillterData() {
        ...
        keKhaiHangHoaNhapKhoDnTrongNuocService.getHistories(choiceObj, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiHangHoaNhapKhoDnTrongNuocCreateController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log', '$rootScope',
    'nvService', 'keKhaiHangHoaNhapKhoDnTrongNuocService', 'mdService', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log, $rootScope,
        nvService, keKhaiHangHoaNhapKhoDnTrongNuocService, mdService, configService, serviceNhapHangAndMerchandise, focus) {
        $scope.robot = angular.copy(keKhaiHangHoaNhapKhoDnTrongNuocService.robot);
        $scope.paged = angular.copy(configService.pageDefault);
        $scope.config = nvService.config;
        $scope.tempData = mdService.tempData;
        $scope.newItem = {};
        ...
        $scope.selectedMaHang = function (code) {
            if (code) {
                keKhaiHangHoaNhapKhoDnTrongNuocService.getMerchandiseForNvByCode(code).then(function (response) {
        ...
        $scope.save = function () {
            $scope.Loading = true;
            keKhaiHangHoaNhapKhoDnTrongNuocService.post(
        ...
        function filterData() {
            $scope.isLoading = true;
            keKhaiHangHoaNhapKhoDnTrongNuocService.getNewInstance(function (response) {
                ...
                //keKhaiHangHoaNhapKhoDnTrongNuocService.getCurrentUser(function (response) {
...
nvModule.controller('keKhaiHangHoaNhapKhoDnTrongNuocEditController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log',
    'nvService', 'keKhaiHangHoaNhapKhoDnTrongNuocService', 'mdService', 'targetData', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log,
        ...
        $scope.save = function () {
            keKhaiHangHoaNhapKhoDnTrongNuocService.updateCT($scope.target).then(
                    function (response) {
            ...
            keKhaiHangHoaNhapKhoDnTrongNuocService.updateCT($scope.target).then(
                    function (response) {
                        if (response.data.status) {
                            ...
                            var url = $state.href('reportkeKhaiHangHoaNhapKhoDnTrongNuoc', { id: response.data.data.id });
...
nvModule.controller('reportkeKhaiHangHoaNhapKhoDnTrongNuocController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state', '$uibModalInstance', 'targetData', '$rootScope',
    'mdService', 'keKhaiHangHoaNhapKhoDnTrongNuocService', 'clientService',
    function ($scope, $filter, $window, $stateParams, $timeout, $state, $uibModalInstance, targetData, $rootScope,
        ...
        function filterData() {
            if (targetData.id) {
                keKhaiHangHoaNhapKhoDnTrongNuocService.getReport(targetData.id, function (response) {
                    if (response.status) {
                        $scope.target = response.data;
                    }
        ...
        $scope.goIndex = function () {
            $state.go("nvKeKhaiHangNhapKhoDnTrongNuoc");
        };
...
nvModule.controller('printkeKhaiHangHoaNhapKhoDnTrongNuocController', [
    ...
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        ...
        function filterData() {
            keKhaiHangHoaNhapKhoDnTrongNuocService.postPrint(
                function (response) {
                    $scope.printData = response;
                });
        };

        $scope.info = keKhaiHangHoaNhapKhoDnTrongNuocService.getParameterPrint().filtered.advanceData;
        $scope.goIndex = function () {
            $state.go("nvKeKhaiHangNhapKhoDnTrongNuoc");
        }
        $scope.printExcel = function () {
...
nvModule.controller('printDetailkeKhaiHangHoaNhapKhoDnTrongNuocController', [
    '$scope', '$state', '$window', '$stateParams', '$timeout', '$filter',
    'mdService', 'keKhaiHangHoaNhapKhoDnTrongNuocService', 'clientService',
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        mdService, keKhaiHangHoaNhapKhoDnTrongNuocService, clientService) {
        ...
        function filterData() {
            keKhaiHangHoaNhapKhoDnTrongNuocService.postPrintDetail(
                function (response) {
                    $scope.printData = response;
                });
        }
...
nvModule.controller('keKhaiHangHoaNhapKhoDnTrongNuocExportItemController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state',
    'mdService', 'keKhaiHangHoaNhapKhoDnTrongNuocService', 'clientService', '$uibModalInstance', 'targetData', 'Excel', 'configService', '$location',
    function ($scope, $filter, $window, $stateParams, $timeout, $state,
        ...
        keKhaiHangHoaNhapKhoDnTrongNuocService.getUnitName($scope.maDonVi).then(function (response) {
            $scope.tenDonVi = response.data;
        });
        keKhaiHangHoaNhapKhoDnTrongNuocService.getInfoItemDetails($scope.target.id, function (response) {
            console.log(response);
            if (response.status) {
        ...
        $scope.exportToExcel = function () {
            keKhaiHangHoaNhapKhoDnTrongNuocService.writeDataToExcel($scope.dataHangHoa, function (response) {
                if (response.status) {
                    clientService.noticeAlert("Thành công", "success");
                    //  $uibModalInstance.close($scope.target);
                }
