var keKhaiHangHoaNhapTuTauVeKhoService = nvModule.factory('keKhaiHangHoaNhapTuTauVeKhoService',
[
    '$resource', '$http', '$window', 'configService', 'clientService',
    function ($resource, $http, $window, configService, clientService) {
        var rootUrl = configService.apiServiceBaseUri;
        var serviceUrl = rootUrl + '/api/Nv/NhapHangTuTauVeKho/NhapHangTuTauVeKho';
...
var keKhaiHangHoaNhapTuTauVeKhoController = nvModule.controller('keKhaiHangHoaNhapTuTauVeKhoController', [
    '$scope', '$rootScope', '$location', '$window', '$uibModal', '$log', '$state', '$filter', '$http',
    'keKhaiHangHoaNhapTuTauVeKhoService', 'configService', 'clientService', 'nvService', 'mdService', 'blockUI', 'serviceNhapHangAndMerchandise', '$mdDialog', 'localStorageService', 'authorizeService', 'serviceCompanySelected',
    function (
        $scope, $rootScope, $location, $window, $uibModal, $log, $state, $filter, $http,
        keKhaiHangHoaNhapTuTauVeKhoService, configService, clientService, nvService, mdService, blockUI, serviceNhapHangAndMerchandise, $mdDialog, localStorageService, authorizeService, serviceCompanySelected
    ) {
        ...
        $scope.selectedCompany = function (code) {
            if (code) {
                keKhaiHangHoaNhapTuTauVeKhoService.getSelectCompanyByCode(code).then(function (response) {
        ...
        $scope.title = function () {
            return 'Phiếu kê khai hàng hóa nhập vào kho từ phiếu xuất tàu bay';
        };
        ...
        $scope.create = function () {
            ...
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangHoaNhapTuTauVeKho', 'add'),
                controller: 'keKhaiHangHoaNhapTuTauVeKhoCreateController',
        ...
        $scope.details = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangHoaNhapTuTauVeKho', 'details'),
                controller: 'keKhaiHangHoaNhapTuTauVeKhoDetailsController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.histories = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangHoaNhapTuTauVeKho', 'histories'),
                controller: 'keKhaiHangHoaNhapTuTauVeKhoHistoryController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.printITem = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvkeKhaiHangHoaNhapTuTauVeKho', 'printItem'),
                controller: 'keKhaiHangHoaNhapTuTauVeKhoExportItemController',
                windowClass: 'app-modal-window',
                resolve: {
                    targetData: function () {
                        return target;
        ...
        $scope.printPopup = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvkeKhaiHangHoaNhapTuTauVeKho', 'report'),
        ...
        $scope.update = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangHoaNhapTuTauVeKho', 'update'),
                controller: 'keKhaiHangHoaNhapTuTauVeKhoEditController',
                windowClass: 'app-modal-window',
                //size:'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.print = function () {
            ...
            keKhaiHangHoaNhapTuTauVeKhoService.setParameterPrint(
                postdata);
            $state.go("nvPrintkeKhaiHangHoaNhapTuTauVeKho");
        }
        ...
        $scope.printDetail = function () {
            ...
            keKhaiHangHoaNhapTuTauVeKhoService.setParameterPrint(
                postdata);
            $state.go("nvPrintDetailkeKhaiHangHoaNhapTuTauVeKho");
        }
        ...
        $scope.deleteItem = function (ev, item) {
            ...
            $mdDialog.show(confirm).then(function () {
                keKhaiHangHoaNhapTuTauVeKhoService.deleteItem(item).then(function (data) {
                    console.log(data);
                }).then(function (data) {
                    $mdDialog.show(
                            $mdDialog.alert()
        ...
        $scope.import = function () {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangXuatKhoDn', 'NvkeKhaiHangHoaNhapTuTauVeKho', 'import'),
                controller: 'keKhaiHangHoaNhapTuTauVeKhoImportController',
                size: 'md'
            });
            modalInstance.result.then(function (updatedData) {
                serviceNhapHangAndMerchandise.getSelectData().clear();
        ...
        function filterData() {
            ...
            var postdata = { paged: $scope.paged, filtered: $scope.filtered };
            keKhaiHangHoaNhapTuTauVeKhoService.postQuery(
...
nvModule.controller('keKhaiHangHoaNhapTuTauVeKhoDetailsController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangHoaNhapTuTauVeKhoService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    ...
    $scope.tempData = mdService.tempData;
    $scope.title = function () {
        return 'Phiếu kê khai hàng hóa nhập từ tàu bay về kho';
    };
    ...
    $scope.approval = function () {
        keKhaiHangHoaNhapTuTauVeKhoService.postApproval($scope.target, function (response) {
            if (response) {
                alert("Duyệt thành công!");
                $uibModalInstance.close($scope.target);
                $scope.goIndex = function () {
                    $state.go('NvkeKhaiHangHoaNhapTuTauVeKho');
                };
    ...
    function fillterData() {
        $scope.isLoading = true;
        keKhaiHangHoaNhapTuTauVeKhoService.getDetails($scope.target.id, function (response) {
            console.log(response);
            if (response.status) {
...
nvModule.controller('keKhaiHangHoaNhapTuTauVeKhoHistoryController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangHoaNhapTuTauVeKhoService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    mdService, keKhaiHangHoaNhapTuTauVeKhoService, targetData, clientService, configService, $filter) {
    ...
    function fillterData() {
        ...
        keKhaiHangHoaNhapTuTauVeKhoService.getHistories(choiceObj, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiHangHoaNhapTuTauVeKhoCreateController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log', '$rootScope',
    'nvService', 'keKhaiHangHoaNhapTuTauVeKhoService', 'mdService', 'configService', 'serviceNhapHangAndMerchandise', 'focus', '$resource',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log, $rootScope,
        nvService, keKhaiHangHoaNhapTuTauVeKhoService, mdService, configService, serviceNhapHangAndMerchandise, focus, $resource) {
        var rootUrl = configService.apiServiceBaseUri;

        $scope.robot = angular.copy(keKhaiHangHoaNhapTuTauVeKhoService.robot);
        $scope.paged = angular.copy(configService.pageDefault);
        $scope.config = nvService.config;
        $scope.tempData = mdService.tempData;
        $scope.newItem = {};
        ...
        $scope.title = function () {
            return 'Kê khai hàng hóa nhập từ tàu bay về kho';
        };
        $scope.selectedkhachHang = function (item) {
            $scope.target.maKhachHang = item.value;
            keKhaiHangHoaNhapTuTauVeKhoService.getOrderByCustomer(item.value, function (response) {
                $scope.donHangs = response;
            });
            keKhaiHangHoaNhapTuTauVeKhoService.getCustomer(item.id, function (response) {
                $scope.target.maSoThue = response.maSoThue;
            });
        };
        $scope.selectedDonDatHang = function (item) {
            $scope.isLoading = true;
            keKhaiHangHoaNhapTuTauVeKhoService.getOrderById(item.id, function (response) {
        ...
        $scope.selectedMaHang = function (code) {
            if (code) {
                keKhaiHangHoaNhapTuTauVeKhoService.getMerchandiseForNvByCode(code).then(function (response) {
        ...
        $scope.save = function () {
            $scope.Loading = true;
            keKhaiHangHoaNhapTuTauVeKhoService.post(
        ...
        function filterData() {
            $scope.isLoading = true;
            keKhaiHangHoaNhapTuTauVeKhoService.getNewInstance(function (response) {
                ...
                //keKhaiHangHoaNhapTuTauVeKhoService.getCurrentUser(function (response) {
...
nvModule.controller('keKhaiHangHoaNhapTuTauVeKhoEditController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log',
    'nvService', 'keKhaiHangHoaNhapTuTauVeKhoService', 'mdService', 'targetData', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log,
        ...
        $scope.save = function () {
            keKhaiHangHoaNhapTuTauVeKhoService.updateCT($scope.target).then(
                    function (response) {
            ...
            keKhaiHangHoaNhapTuTauVeKhoService.updateCT($scope.target).then(
                    function (response) {
                        if (response.data.status) {
                            ...
                            var url = $state.href('reportkeKhaiHangHoaNhapTuTauVeKho', { id: response.data.data.id });
...
nvModule.controller('reportKeKhaiHangHoaNhapTuTauVeKhoController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state', '$uibModalInstance', 'targetData', '$rootScope',
    'mdService', 'keKhaiHangHoaNhapTuTauVeKhoService', 'clientService',
    function ($scope, $filter, $window, $stateParams, $timeout, $state, $uibModalInstance, targetData, $rootScope,
        ...
        function filterData() {
            if (targetData.id) {
                keKhaiHangHoaNhapTuTauVeKhoService.getReport(targetData.id, function (response) {
...
nvModule.controller('printkeKhaiHangHoaNhapTuTauVeKhoController', [
    ...
    function($scope, $state, $window, $stateParams, $timeout, $filter,
        ...
        function filterData() {
            keKhaiHangHoaNhapTuTauVeKhoService.postPrint(
                function(response) {
                    $scope.printData = response;
                });
        };

        $scope.info = keKhaiHangHoaNhapTuTauVeKhoService.getParameterPrint().filtered.advanceData;
        $scope.goIndex = function() {
            $state.go("NvkeKhaiHangHoaNhapTuTauVeKho");
        }
        $scope.printExcel = function() {
...
nvModule.controller('printDetailkeKhaiHangHoaNhapTuTauVeKhoController', [
    '$scope', '$state', '$window', '$stateParams', '$timeout', '$filter',
    'mdService', 'keKhaiHangHoaNhapTuTauVeKhoService', 'clientService',
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        mdService, keKhaiHangHoaNhapTuTauVeKhoService, clientService) {
        ...
        function filterData() {
            keKhaiHangHoaNhapTuTauVeKhoService.postPrintDetail(
                function (response) {
                    $scope.printData = response;
                });
        }
...
nvModule.controller('keKhaiHangHoaNhapTuTauVeKhoExportItemController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state',
    'mdService', 'keKhaiHangHoaNhapTuTauVeKhoService', 'clientService', '$uibModalInstance', 'targetData', 'Excel', 'configService', '$location',
    function ($scope, $filter, $window, $stateParams, $timeout, $state,
        ...
        keKhaiHangHoaNhapTuTauVeKhoService.getUnitName($scope.maDonVi).then(function (response) {
            $scope.tenDonVi = response.data;
        });
        keKhaiHangHoaNhapTuTauVeKhoService.getInfoItemDetails($scope.target.id, function (response) {
            console.log(response);
            if (response.status) {
        ...
        $scope.exportToExcel = function () {
            keKhaiHangHoaNhapTuTauVeKhoService.writeDataToExcel($scope.dataHangHoa, function (response) {
                if (response.status) {
                    clientService.noticeAlert("Thành công", "success");
                    //  $uibModalInstance.close($scope.target);
                }
