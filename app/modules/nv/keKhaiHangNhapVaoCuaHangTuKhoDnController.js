var keKhaiHangNhapVaoCuaHangTuKhoDnService = nvModule.factory('keKhaiHangNhapVaoCuaHangTuKhoDnService',
[
    '$resource', '$http', '$window', 'configService', 'clientService',
    function ($resource, $http, $window, configService, clientService) {
        var rootUrl = configService.apiServiceBaseUri;
        var serviceUrl = rootUrl + '/api/Nv/KeKhaiHangNhapKhoDn/KeKhaiHangNhapVaoCuaHangTuKhoDn';
...
var keKhaiHangNhapVaoCuaHangTuKhoDnController = nvModule.controller('keKhaiHangNhapVaoCuaHangTuKhoDnController', [
    '$scope', '$rootScope', '$location', '$window', '$uibModal', '$log', '$state', '$filter', '$http',
    'keKhaiHangNhapVaoCuaHangTuKhoDnService', 'configService', 'clientService', 'nvService', 'mdService', 'blockUI', 'serviceNhapHangAndMerchandise', '$mdDialog', 'localStorageService', 'authorizeService', 'serviceCompanySelected',
    function (
        $scope, $rootScope, $location, $window, $uibModal, $log, $state, $filter, $http,
        keKhaiHangNhapVaoCuaHangTuKhoDnService, configService, clientService, nvService, mdService, blockUI, serviceNhapHangAndMerchandise, $mdDialog, localStorageService, authorizeService, serviceCompanySelected
    ) {
        ...
        $scope.selectedCompany = function (code) {
            if (code) {
                keKhaiHangNhapVaoCuaHangTuKhoDnService.getSelectCompanyByCode(code).then(function (response) {
        ...
        $scope.title = function () {
            return 'Phiếu kê khai hàng hóa nhập vào cửa hàng từ phiếu xuất kho';
        };
        ...
        $scope.create = function () {
            ...
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangNhapVaoCuaHangTuKho', 'add'),
                controller: 'keKhaiHangNhapVaoCuaHangTuKhoCreateController',
        ...
        $scope.details = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangNhapVaoCuaHangTuKho', 'details'),
                controller: 'keKhaiHangNhapVaoCuaHangTuKhoDetailsController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.histories = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangNhapVaoCuaHangTuKho', 'histories'),
                controller: 'keKhaiHangNhapVaoCuaHangTuKhoHistoryController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.printPopup = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangNhapVaoCuaHangTuKho', 'report'),
        ...
        $scope.printITem = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangNhapVaoCuaHangTuKho', 'printItem'),
                controller: 'keKhaiHangNhapVaoCuaHangTuKhoExportItemController',
                windowClass: 'app-modal-window',
                resolve: {
                    targetData: function () {
                        return target;
        ...
        $scope.update = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangNhapVaoCuaHangTuKho', 'update'),
                controller: 'keKhaiHangNhapVaoCuaHangTuKhoEditController',
                windowClass: 'app-modal-window',
                //size:'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.print = function () {
            ...
            keKhaiHangNhapVaoCuaHangTuKhoDnService.setParameterPrint(
                postdata);
            $state.go("nvPrintkeKhaiHangNhapVaoCuaHangTuKho");
        }
        $scope.printDetail = function () {
            ...
            keKhaiHangNhapVaoCuaHangTuKhoDnService.setParameterPrint(
                postdata);
            $state.go("nvPrintDetailkeKhaiHangNhapVaoCuaHangTuKho");
        }
        ...
        $scope.deleteItem = function (ev, item) {
            ...
            $mdDialog.show(confirm).then(function () {
                keKhaiHangNhapVaoCuaHangTuKhoDnService.deleteItem(item).then(function (data) {
                    console.log(data);
                }).then(function (data) {
                    $mdDialog.show(
                            $mdDialog.alert()
        ...
        $scope.import = function () {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangNhapVaoCuaHangTuKho', 'import'),
                controller: 'keKhaiHangNhapVaoCuaHangTuKhoImportController',
                size: 'md'
            });
            modalInstance.result.then(function (updatedData) {
                serviceNhapHangAndMerchandise.getSelectData().clear();
        ...
        function filterData() {
            ...
            var postdata = { paged: $scope.paged, filtered: $scope.filtered };
            keKhaiHangNhapVaoCuaHangTuKhoDnService.postQuery(
...
nvModule.controller('keKhaiHangNhapVaoCuaHangTuKhoDetailsController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangNhapVaoCuaHangTuKhoDnService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    ...
    $scope.approval = function () {
        keKhaiHangNhapVaoCuaHangTuKhoDnService.postApproval($scope.target, function (response) {
            if (response) {
                alert("Duyệt thành công!");
                $uibModalInstance.close($scope.target);
                $scope.goIndex = function () {
                    $state.go('NvKeKhaiHangNhapVaoCuaHangTuKho');
                };
    ...
    function fillterData() {
        $scope.isLoading = true;
        keKhaiHangNhapVaoCuaHangTuKhoDnService.getDetails($scope.target.id, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiHangNhapVaoCuaHangTuKhoHistoryController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangNhapVaoCuaHangTuKhoDnService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    mdService, keKhaiHangNhapVaoCuaHangTuKhoDnService, targetData, clientService, configService, $filter) {
    ...
    $scope.tempData = mdService.tempData;
    $scope.title = function () {
        return 'Phiếu kê khai hàng hóa nhập vào cửa hàng từ kho doanh nghiệp';
    };
    ...
    function fillterData() {
        ...
        keKhaiHangNhapVaoCuaHangTuKhoDnService.getHistories(choiceObj, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiHangNhapVaoCuaHangTuKhoCreateController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log', '$rootScope',
    'nvService', 'keKhaiHangNhapVaoCuaHangTuKhoDnService', 'mdService', 'configService', 'serviceNhapHangAndMerchandise', 'focus', '$resource',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log, $rootScope,
        nvService, keKhaiHangNhapVaoCuaHangTuKhoDnService, mdService, configService, serviceNhapHangAndMerchandise, focus, $resource) {
        var rootUrl = configService.apiServiceBaseUri;

        $scope.robot = angular.copy(keKhaiHangNhapVaoCuaHangTuKhoDnService.robot);
        $scope.paged = angular.copy(configService.pageDefault);
        $scope.config = nvService.config;
        $scope.tempData = mdService.tempData;
        $scope.newItem = {};
        ...
        $scope.selectedMaHang = function (code) {
            if (code) {
                keKhaiHangNhapVaoCuaHangTuKhoDnService.getMerchandiseForNvByCode(code).then(function (response) {
        ...
        $scope.save = function () {
            $scope.Loading = true;
            keKhaiHangNhapVaoCuaHangTuKhoDnService.post(
        ...
        function filterData() {
            $scope.isLoading = true;
            keKhaiHangNhapVaoCuaHangTuKhoDnService.getNewInstance(function (response) {
                ...
                //keKhaiHangNhapVaoCuaHangTuKhoDnService.getCurrentUser(function (response) {
...
nvModule.controller('keKhaiHangNhapVaoCuaHangTuKhoEditController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log',
    'nvService', 'keKhaiHangNhapVaoCuaHangTuKhoDnService', 'mdService', 'targetData', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log,
        ...
        $scope.selectedkhachHang = function (item) {
            ...
            keKhaiHangNhapVaoCuaHangTuKhoDnService.getCustomer(item.id, function (response) {
        ...
        $scope.save = function () {
            keKhaiHangNhapVaoCuaHangTuKhoDnService.updateCT($scope.target).then(
                    function (response) {
            ...
            keKhaiHangNhapVaoCuaHangTuKhoDnService.updateCT($scope.target).then(
                    function (response) {
                        if (response.data.status) {
                            ...
                            var url = $state.href('reportkeKhaiHangNhapVaoCuaHangTuKho', { id: response.data.data.id });
...
nvModule.controller('reportKeKhaiHangNhapVaoCuaHangTuKhoController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state', '$uibModalInstance', 'targetData', '$rootScope',
    'mdService', 'keKhaiHangNhapVaoCuaHangTuKhoDnService', 'clientService',
    function ($scope, $filter, $window, $stateParams, $timeout, $state, $uibModalInstance, targetData, $rootScope,
        ...
        $scope.title = "PHIẾU KÊ KHAI HÀNG HÓA NHẬP VÀO CỬA HÀNG TỪ PHIẾU XUẤT KHO ";

        function filterData() {
            if (targetData.id) {
                keKhaiHangNhapVaoCuaHangTuKhoDnService.getReport(targetData.id, function (response) {
                    console.log(response);
                    if (response.status) {
                        $scope.target = response.data;
                    }
...
nvModule.controller('printkeKhaiHangNhapVaoCuaHangTuKhoController', [
    ...
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        ...
        function filterData() {
            keKhaiHangNhapVaoCuaHangTuKhoDnService.postPrint(
                function (response) {
                    $scope.printData = response;
                });
        };

        $scope.info = keKhaiHangNhapVaoCuaHangTuKhoDnService.getParameterPrint().filtered.advanceData;
        $scope.goIndex = function () {
            $state.go("NvKeKhaiHangNhapVaoCuaHangTuKho");
        }
        $scope.printExcel = function () {
...
nvModule.controller('printDetailkeKhaiHangNhapVaoCuaHangTuKhoController', [
    '$scope', '$state', '$window', '$stateParams', '$timeout', '$filter',
    'mdService', 'keKhaiHangNhapVaoCuaHangTuKhoDnService', 'clientService',
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        mdService, keKhaiHangNhapVaoCuaHangTuKhoDnService, clientService) {
        ...
        function filterData() {
            keKhaiHangNhapVaoCuaHangTuKhoDnService.postPrintDetail(
                function (response) {
                    $scope.printData = response;
                });
        }
...
nvModule.controller('keKhaiHangNhapVaoCuaHangTuKhoExportItemController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state',
    'mdService', 'keKhaiHangNhapVaoCuaHangTuKhoDnService', 'clientService', '$uibModalInstance', 'targetData', 'Excel', 'configService', '$location',
    function ($scope, $filter, $window, $stateParams, $timeout, $state,
        ...
        keKhaiHangNhapVaoCuaHangTuKhoDnService.getUnitName($scope.maDonVi).then(function (response) {
            $scope.tenDonVi = response.data;
        });
        keKhaiHangNhapVaoCuaHangTuKhoDnService.getInfoItemDetails($scope.target.id, function (response) {
            console.log(response);
            if (response.status) {
        ...
        $scope.exportToExcel = function () {
            keKhaiHangNhapVaoCuaHangTuKhoDnService.writeDataToExcel($scope.dataHangHoa, function (response) {
                if (response.status) {
                    clientService.noticeAlert("Thành công", "success");
                    //  $uibModalInstance.close($scope.target);
                }
