var keKhaiHangNhapVaoKhoDnTuCuaHangService = nvModule.factory('keKhaiHangNhapVaoKhoDnTuCuaHangService',
[
    '$resource', '$http', '$window', 'configService', 'clientService',
    function ($resource, $http, $window, configService, clientService) {
        var rootUrl = configService.apiServiceBaseUri;
        var serviceUrl = rootUrl + '/api/Nv/KeKhaiHangNhapKhoDn/KeKhaiHangNhapVaoKhoDnTuCuaHang';
...
var keKhaiHangNhapVaoKhoDnTuCuaHangController = nvModule.controller('keKhaiHangNhapVaoKhoDnTuCuaHangController', [
    '$scope', '$rootScope', '$location', '$window', '$uibModal', '$log', '$state', '$filter', '$http',
    'keKhaiHangNhapVaoKhoDnTuCuaHangService', 'configService', 'clientService', 'nvService', 'mdService', 'blockUI', 'serviceNhapHangAndMerchandise', '$mdDialog', 'localStorageService', 'authorizeService', 'serviceCompanySelected',
    function (
        $scope, $rootScope, $location, $window, $uibModal, $log, $state, $filter, $http,
        keKhaiHangNhapVaoKhoDnTuCuaHangService, configService, clientService, nvService, mdService, blockUI, serviceNhapHangAndMerchandise, $mdDialog, localStorageService, authorizeService, serviceCompanySelected) {
        ...
        $scope.selectedCompany = function (code) {
            if (code) {
                keKhaiHangNhapVaoKhoDnTuCuaHangService.getSelectCompanyByCode(code).then(function (response) {
        ...
        $scope.title = function () {
            return 'Phiếu kê khai hàng hóa nhập vào kho từ phiếu xuất cửa hàng';
        };
        ...
        $scope.create = function () {
            ...
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangNhapVaoKhoTuCuaHang', 'add'),
                controller: 'keKhaiHangNhapVaoKhoDnTuCuaHangCreateController',
        ...
        $scope.details = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangNhapVaoKhoTuCuaHang', 'details'),
                controller: 'keKhaiHangNhapVaoKhoDnTuCuaHangDetailsController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.histories = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangNhapVaoKhoTuCuaHang', 'histories'),
                controller: 'keKhaiHangNhapVaoKhoDnTuCuaHangHistoryController',
                windowClass: 'app-modal-window',
                //size: 'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.printITem = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangNhapVaoKhoTuCuaHang', 'printItem'),
                controller: 'keKhaiHangNhapVaoKhoDnTuCuaHangExportItemController',
                windowClass: 'app-modal-window',
                resolve: {
                    targetData: function () {
                        return target;
        ...
        $scope.printPopup = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangNhapVaoKhoTuCuaHang', 'report'),
        ...
        $scope.update = function (target) {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'NvKeKhaiHangNhapVaoKhoTuCuaHang', 'update'),
                controller: 'keKhaiHangNhapVaoKhoDnTuCuaHangEditController',
                windowClass: 'app-modal-window',
                //size:'lg',
                resolve: {
                    targetData: function () {
        ...
        $scope.print = function () {
            ...
            keKhaiHangNhapVaoKhoDnTuCuaHangService.setParameterPrint(
                postdata);
            $state.go("nvPrintkeKhaiHangNhapVaoKhoDnTuCuaHang");
        }
        $scope.printDetail = function () {
            ...
            keKhaiHangNhapVaoKhoDnTuCuaHangService.setParameterPrint(
                postdata);
            $state.go("nvPrintDetailkeKhaiHangNhapVaoKhoDnTuCuaHang");
        }
        ...
        $scope.deleteItem = function (ev, item) {
            ...
            $mdDialog.show(confirm).then(function () {
                keKhaiHangNhapVaoKhoDnTuCuaHangService.deleteItem(item).then(function (data) {
                    console.log(data);
                }).then(function (data) {
                    $mdDialog.show(
                            $mdDialog.alert()
        ...
        $scope.import = function () {
            var modalInstance = $uibModal.open({
                backdrop: 'static',
                templateUrl: nvService.buildUrlTax('KeKhaiHangNhapKhoDn', 'nvkeKhaiHangNhapVaoKhoDnTuCuaHang', 'import'),
                controller: 'keKhaiHangNhapVaoKhoDnTuCuaHangImportController',
                size: 'md'
            });
            modalInstance.result.then(function (updatedData) {
                serviceNhapHangAndMerchandise.getSelectData().clear();
        ...
        function filterData() {
            ...
            var postdata = { paged: $scope.paged, filtered: $scope.filtered };
            keKhaiHangNhapVaoKhoDnTuCuaHangService.postQuery(
...
nvModule.controller('keKhaiHangNhapVaoKhoDnTuCuaHangDetailsController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangNhapVaoKhoDnTuCuaHangService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    ...
    $scope.nameCompany = function (model, module) {
        if (!model) return "";
        var data = $filter('filter')(mdService.tempData[module], { id: model }, true);
        if (data && data.length == 1) {
            return data[0].description;
    ...
    $scope.approval = function () {
        keKhaiHangNhapVaoKhoDnTuCuaHangService.postApproval($scope.target, function (response) {
            if (response) {

                alert("Duyệt thành công!");
                $uibModalInstance.close($scope.target);
                $scope.goIndex = function () {
                    $state.go('nvkeKhaiHangNhapVaoKhoDnTuCuaHang');
                };
    ...
    function fillterData() {
        ...
        keKhaiHangNhapVaoKhoDnTuCuaHangService.getDetails($scope.target.id, function (response) {
            if (response.status) {
            ...
            var dataWarehouse = $filter('filter')(mdService.tempData.wareHouses, { value: $scope.target.maKhoNhap }, true);
            if (data && dataCustom && dataWarehouse && item) {
                $scope.target.tenDoanhNghiep = data[0].description;
...
nvModule.controller('keKhaiHangNhapVaoKhoDnTuCuaHangHistoryController', [
'$scope', '$uibModalInstance',
'mdService', 'keKhaiHangNhapVaoKhoDnTuCuaHangService', 'targetData', 'clientService', 'configService', '$filter',
function ($scope, $uibModalInstance,
    mdService, keKhaiHangNhapVaoKhoDnTuCuaHangService, targetData, clientService, configService, $filter) {
    ...
    function fillterData() {
        ...
        keKhaiHangNhapVaoKhoDnTuCuaHangService.getHistories(choiceObj, function (response) {
            if (response.status) {
...
nvModule.controller('keKhaiHangNhapVaoKhoDnTuCuaHangCreateController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log', '$rootScope',
    'nvService', 'keKhaiHangNhapVaoKhoDnTuCuaHangService', 'mdService', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log, $rootScope,
        nvService, keKhaiHangNhapVaoKhoDnTuCuaHangService, mdService, configService, serviceNhapHangAndMerchandise, focus) {
        $scope.robot = angular.copy(keKhaiHangNhapVaoKhoDnTuCuaHangService.robot);
        $scope.paged = angular.copy(configService.pageDefault);
        $scope.config = nvService.config;
        $scope.tempData = mdService.tempData;
        $scope.newItem = {};
                ...
                if (exsist) {
                    ...
                    angular.forEach($scope.target.dataDetails, function (v, k) {
                        if (v.maHang == $scope.newItem.maHang && $scope.newItem.soToKhai == v.soToKhai) {
                            ...
                            keKhaiHangNhapVaoKhoDnTuCuaHangService.robot.changeSoLuong($scope.target.dataDetails[k]);
                        }
                    });
                } else {
        ...
        $scope.selectedMaHang = function (code) {
            if (code) {
                keKhaiHangNhapVaoKhoDnTuCuaHangService.getMerchandiseForNvByCode(code).then(function (response) {
        ...
        $scope.save = function () {
            ...
            $scope.Loading = true;
            keKhaiHangNhapVaoKhoDnTuCuaHangService.post(
        ...
        function filterData() {
            $scope.isLoading = true;
            keKhaiHangNhapVaoKhoDnTuCuaHangService.getNewInstance(function (response) {
                ...
                //keKhaiHangNhapVaoKhoDnTuCuaHangService.getCurrentUser(function (response) {
...
nvModule.controller('keKhaiHangNhapVaoKhoDnTuCuaHangEditController', [
    '$scope', '$uibModalInstance', 'clientService', '$filter', '$state', '$uibModal', '$log',
    'nvService', 'keKhaiHangNhapVaoKhoDnTuCuaHangService', 'mdService', 'targetData', 'configService', 'serviceNhapHangAndMerchandise', 'focus',
    function ($scope, $uibModalInstance, clientService, $filter, $state, $uibModal, $log,
        ...
        $scope.save = function () {
            keKhaiHangNhapVaoKhoDnTuCuaHangService.updateCT($scope.target).then(
                    function (response) {
            ...
            keKhaiHangNhapVaoKhoDnTuCuaHangService.updateCT($scope.target).then(
                    function (response) {
                        if (response.data.status) {
                            ...
                            var url = $state.href('reportkeKhaiHangNhapVaoKhoDnTuCuaHang', { id: response.data.data.id });
        ...
        function filterData() {
            keKhaiHangNhapVaoKhoDnTuCuaHangService.getDetails($scope.target.id, function (response) {
                if (response.data.id) {
                    ...
                    var nameWarehouse = $filter('filter')(mdService.tempData.wareHouses, { value: $scope.target.maKhoNhap }, true);
                    if (nameCustomer && nameCustom) {
                        ...
                        $scope.target.tenKhoNhap = nameWarehouse[0].description;
...
nvModule.controller('reportKeKhaiHangNhapVaoKhoDnTuCuaHangController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state', '$uibModalInstance', 'targetData', '$rootScope',
    'mdService', 'keKhaiHangNhapVaoKhoDnTuCuaHangService', 'clientService',
    function ($scope, $filter, $window, $stateParams, $timeout, $state, $uibModalInstance, targetData, $rootScope,
        ...
        $scope.title = "PHIẾU KÊ KHAI HÀNG HÓA NHẬP VÀO KHO TỪ PHIẾU XUẤT CỬA HÀNG";
        ...
        function filterData() {
            if (targetData.id) {
                keKhaiHangNhapVaoKhoDnTuCuaHangService.getReport(targetData.id, function (response) {
                    console.log(response);
                    if (response.status) {
                        $scope.target = response.data;
...
nvModule.controller('printkeKhaiHangNhapVaoKhoDnTuCuaHangController', [
    ...
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        ...
        function filterData() {
            keKhaiHangNhapVaoKhoDnTuCuaHangService.postPrint(
                function (response) {
                    $scope.printData = response;
                });
        };

        $scope.info = keKhaiHangNhapVaoKhoDnTuCuaHangService.getParameterPrint().filtered.advanceData;
        $scope.goIndex = function () {
            $state.go("nvKeKhaiHangNhapVaoKhoDnTuCuaHang");
        }
        $scope.printExcel = function () {
...
nvModule.controller('printDetailkeKhaiHangNhapVaoKhoDnTuCuaHangController', [
    '$scope', '$state', '$window', '$stateParams', '$timeout', '$filter',
    'mdService', 'keKhaiHangNhapVaoKhoDnTuCuaHangService', 'clientService',
    function ($scope, $state, $window, $stateParams, $timeout, $filter,
        mdService, keKhaiHangNhapVaoKhoDnTuCuaHangService, clientService) {
        ...
        function filterData() {
            keKhaiHangNhapVaoKhoDnTuCuaHangService.postPrintDetail(
                function (response) {
                    $scope.printData = response;
                });
        }
...
nvModule.controller('keKhaiHangNhapVaoKhoDnTuCuaHangExportItemController', [
    '$scope', '$filter', '$window', '$stateParams', '$timeout', '$state',
    'mdService', 'keKhaiHangNhapVaoKhoDnTuCuaHangService', 'clientService', '$uibModalInstance', 'targetData', 'Excel', 'configService', '$location',
    function ($scope, $filter, $window, $stateParams, $timeout, $state,
        ...
        keKhaiHangNhapVaoKhoDnTuCuaHangService.getUnitName($scope.maDonVi).then(function (response) {
            $scope.tenDonVi = response.data;
        });
        keKhaiHangNhapVaoKhoDnTuCuaHangService.getInfoItemDetails($scope.target.id, function (response) {
            console.log(response);
            if (response.status) {
        ...
        $scope.exportToExcel = function () {
            keKhaiHangNhapVaoKhoDnTuCuaHangService.writeDataToExcel($scope.dataHangHoa, function (response) {
                if (response.status) {
                    clientService.noticeAlert("Thành công", "success");
                    //  $uibModalInstance.close($scope.target);
                }
